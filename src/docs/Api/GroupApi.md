...
```php
getAllGroupMembers($id, $page, $limit, $role_ids, $allowed_chat_users_only): \StevenBuehner\ChurchTools\Model\InlineResponse20018
```
...
```php
getAllMeetings($id): \StevenBuehner\ChurchTools\Model\InlineResponse20021
```
...
```php
getGroupsHierarchies($ids, $campus_ids, $agegroup_ids, $group_status_ids, $group_category_ids, $target_group_ids, $weekday, $group_type_ids, $is_open_for_members, $is_public, $show_overdue_groups, $show_inactive_groups, $without_my_groups, $query): \StevenBuehner\ChurchTools\Model\InlineResponse20091
```
