 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PublicGroup1 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PublicGroup_1';
...
'sign_up_headline' => 'getSignUpHeadline'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['allow_waitinglist'] = isset($data['allow_waitinglist']) ? $data['allow_waitinglist'] : null;
        $this->container['max_member_count'] = isset($data['max_member_count']) ? $data['max_member_count'] : null;
        $this->container['current_member_count'] = isset($data['current_member_count']) ? $data['current_member_count'] : null;
        $this->container['requested_places_count'] = isset($data['requested_places_count']) ? $data['requested_places_count'] : null;
        $this->container['requested_waitinglist_places_count'] = isset($data['requested_waitinglist_places_count']) ? $data['requested_waitinglist_places_count'] : null;
        $this->container['can_sign_up'] = isset($data['can_sign_up']) ? $data['can_sign_up'] : null;
        $this->container['sign_up_conditions'] = isset($data['sign_up_conditions']) ? $data['sign_up_conditions'] : null;
        $this->container['sign_up_persons'] = isset($data['sign_up_persons']) ? $data['sign_up_persons'] : null;
        $this->container['sign_up_headline'] = isset($data['sign_up_headline']) ? $data['sign_up_headline'] : null;
    }
     ...
     * Sets children
     *
     * @param array $children Lists all (direct) child group IDs for the current group.
     *
     * @return $this
     */
     ...
     *
     * @return \StevenBuehner\ChurchTools\Model\InlineResponse20025SignUpPersons[]
     */
     ...
     *
     * @param \StevenBuehner\ChurchTools\Model\InlineResponse20025SignUpPersons[] $sign_up_persons Lists all persons the current user is allowed to sign up for. This includes spouses, children below the age of 16 and all persons with the same email address.
     *
     * @return $this
     */
     ...
     *
     * @param string $sign_up_headline Text which can be displayed as a headline for the sign up section
     *
     * @return $this
     */
