 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse20025SignUpConditions implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_25_signUpConditions';
...
'new_person_department_is_set' => 'getNewPersonDepartmentIsSet'    ];
    ...
    {
        $this->container['group_is_not_hidden'] = isset($data['group_is_not_hidden']) ? $data['group_is_not_hidden'] : null;
        $this->container['group_is_active'] = isset($data['group_is_active']) ? $data['group_is_active'] : null;
        $this->container['group_is_open_for_members'] = isset($data['group_is_open_for_members']) ? $data['group_is_open_for_members'] : null;
        $this->container['group_is_not_full'] = isset($data['group_is_not_full']) ? $data['group_is_not_full'] : null;
        $this->container['group_has_leader'] = isset($data['group_has_leader']) ? $data['group_has_leader'] : null;
        $this->container['end_date_not_passed'] = isset($data['end_date_not_passed']) ? $data['end_date_not_passed'] : null;
        $this->container['roles_set_in_group'] = isset($data['roles_set_in_group']) ? $data['roles_set_in_group'] : null;
        $this->container['group_is_public'] = isset($data['group_is_public']) ? $data['group_is_public'] : null;
        $this->container['can_contact_leader'] = isset($data['can_contact_leader']) ? $data['can_contact_leader'] : null;
        $this->container['new_person_station_is_set'] = isset($data['new_person_station_is_set']) ? $data['new_person_station_is_set'] : null;
        $this->container['new_person_status_is_set'] = isset($data['new_person_status_is_set']) ? $data['new_person_status_is_set'] : null;
        $this->container['new_person_department_is_set'] = isset($data['new_person_department_is_set']) ? $data['new_person_department_is_set'] : null;
    }
