...
'is_immutable' => 'getIsImmutable'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['is_immutable'] = isset($data['is_immutable']) ? $data['is_immutable'] : false;
    }
     ...
     * Sets is_immutable
     *
     * @param bool $is_immutable If `true` this transaction is immutable and cannot be edited or deleted.
     *
     * @return $this
     */
