...
class InlineResponse20061Data implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'persons' => '\StevenBuehner\ChurchTools\Model\GroupMemberPerson[]',
'count' => 'int',
'sum' => 'float',
...
'last_donation_amount' => 'getLastDonationAmount'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['last_donation_date'] = isset($data['last_donation_date']) ? $data['last_donation_date'] : null;
        $this->container['last_donation_amount'] = isset($data['last_donation_amount']) ? $data['last_donation_amount'] : null;
    }
     ...
     * Sets persons
     *
     * @param \StevenBuehner\ChurchTools\Model\GroupMemberPerson[] $persons Contains either one element (a single donator) or two elements (donator and their spouse).
     *
     * @return $this
     */
     ...
     * Sets sum
     *
     * @param float $sum Value is in cent.
     *
     * @return $this
     */
     ...
     *
     * @param \DateTime $last_donation_date last_donation_date
     *
     * @return $this
     */
     ...
     *
     * @param float $last_donation_amount Value is in cent.
     *
     * @return $this
     */
