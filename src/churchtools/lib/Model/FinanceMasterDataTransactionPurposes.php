...
/**
 * FinanceMasterDataTransactionPurposes Class Doc Comment
 *
 * @category Class
 * @package  StevenBuehner\ChurchTools
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class FinanceMasterDataTransactionPurposes implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'FinanceMasterData_transactionPurposes';
...
'meta' => 'getMeta'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['purpose_account_id'] = isset($data['purpose_account_id']) ? $data['purpose_account_id'] : null;
     ...
     *
     * @param int $purpose_account_id This will always be a single account. But it depends on the `isIncome` flag if this is the debit or the credit account.
     *
     * @return $this
     */
     ...
     * Sets account_ids
     *
     * @param int[] $account_ids account_ids
     *
     * @return $this
     */
