...
'printer_id' => 'getPrinterId'    ];
     ...
     * Sets date
     *
     * @param \DateTime $date date and time of the group meeting in UTC / Zulu format
     *
     * @return $this
     */
     ...
     * Sets token
     *
     * @param string $token optional token of a ticket that is to be validated
     *
     * @return $this
     */
     ...
     * Sets printer_id
     *
     * @param int $printer_id optional printer ID, if a name tag should be printed out
     *
     * @return $this
     */
