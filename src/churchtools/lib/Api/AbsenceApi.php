...
class AbsenceApi
{
     ...
     */
    protected function deletePersonsAbsenceRequest($person_id, $id)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPersonsAbsenceRequest($person_id, $id)
    {
        // verify the required parameter 'person_id' is set
        if ($person_id === null || (is_array($person_id) && count($person_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPersonsAbsencesRequest($person_id, $from_date = null, $to_date = null)
    {
        // verify the required parameter 'person_id' is set
        if ($person_id === null || (is_array($person_id) && count($person_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        // query params
        if ($from_date !== null) {
            $queryParams['from_date'] = ObjectSerializer::toQueryValue($from_date, 'date');
        }
        // query params
        if ($to_date !== null) {
            $queryParams['to_date'] = ObjectSerializer::toQueryValue($to_date, 'date');
        }
     ...
     *
     * @param  string $person_id person_id (required)
     * @param  \StevenBuehner\ChurchTools\Model\Body62 $body Absences can be all-day or with a specific time. Either &#x60;startDate&#x60;, &#x60;endDate&#x60;  or &#x60;startTime&#x60;, &#x60;endTime&#x60; MUST be present. If &#x60;*Time&#x60; is given, the &#x60;*Date&#x60; value will be ignored. (optional)
     *
     * @throws \StevenBuehner\ChurchTools\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \StevenBuehner\ChurchTools\Model\InlineResponse2016
     */
    public function postPersonsAbsences($person_id, $body = null)
    {
        list($response) = $this->postPersonsAbsencesWithHttpInfo($person_id, $body);
        return $response;
    }
     ...
     * @return array of \StevenBuehner\ChurchTools\Model\InlineResponse2016, HTTP status code, HTTP response headers (array of strings)
     */
    public function postPersonsAbsencesWithHttpInfo($person_id, $body = null)
    {
        $returnType = '\StevenBuehner\ChurchTools\Model\InlineResponse2016';
        $request = $this->postPersonsAbsencesRequest($person_id, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postPersonsAbsencesAsync($person_id, $body = null)
    {
        return $this->postPersonsAbsencesAsyncWithHttpInfo($person_id, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postPersonsAbsencesAsyncWithHttpInfo($person_id, $body = null)
    {
        $returnType = '\StevenBuehner\ChurchTools\Model\InlineResponse2016';
        $request = $this->postPersonsAbsencesRequest($person_id, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postPersonsAbsencesRequest($person_id, $body = null)
    {
        // verify the required parameter 'person_id' is set
        if ($person_id === null || (is_array($person_id) && count($person_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @param  string $person_id person_id (required)
     * @param  string $id id (required)
     * @param  \StevenBuehner\ChurchTools\Model\Body63 $body Absences can be all-day or with a specific time. Either &#x60;startDate&#x60;, &#x60;endDate&#x60;  or &#x60;startTime&#x60;, &#x60;endTime&#x60; MUST be present. If &#x60;*Time&#x60; is given, the &#x60;*Date&#x60; value will be ignored. (optional)
     *
     * @throws \StevenBuehner\ChurchTools\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \StevenBuehner\ChurchTools\Model\InlineResponse2016
     */
    public function putPersonsAbsence($person_id, $id, $body = null)
    {
        list($response) = $this->putPersonsAbsenceWithHttpInfo($person_id, $id, $body);
        return $response;
    }
     ...
     * @return array of \StevenBuehner\ChurchTools\Model\InlineResponse2016, HTTP status code, HTTP response headers (array of strings)
     */
    public function putPersonsAbsenceWithHttpInfo($person_id, $id, $body = null)
    {
        $returnType = '\StevenBuehner\ChurchTools\Model\InlineResponse2016';
        $request = $this->putPersonsAbsenceRequest($person_id, $id, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putPersonsAbsenceAsync($person_id, $id, $body = null)
    {
        return $this->putPersonsAbsenceAsyncWithHttpInfo($person_id, $id, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putPersonsAbsenceAsyncWithHttpInfo($person_id, $id, $body = null)
    {
        $returnType = '\StevenBuehner\ChurchTools\Model\InlineResponse2016';
        $request = $this->putPersonsAbsenceRequest($person_id, $id, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function putPersonsAbsenceRequest($person_id, $id, $body = null)
    {
        // verify the required parameter 'person_id' is set
        if ($person_id === null || (is_array($person_id) && count($person_id) === 0)) {
            throw new \InvalidArgumentException(
