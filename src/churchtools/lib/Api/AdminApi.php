...
class AdminApi
{
     ...
     */
    protected function getAllLogsRequest($message = null, $levels = null, $before = null, $after = null, $person_id = null, $page = '1', $limit = '10')
    {
        ...
        // query params
        if ($person_id !== null) {
            $queryParams['person_id'] = ObjectSerializer::toQueryValue($person_id, null);
        }
        // query params
        if ($page !== null) {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getLogByIdRequest($id)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getLoginStatisticsRequest($order_by = null, $page = '1', $limit = '10')
    {
