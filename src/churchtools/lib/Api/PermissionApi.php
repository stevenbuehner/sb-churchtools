...
class PermissionApi
{
     ...
     */
    protected function getGlobalPermissionsRequest()
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getInternalPermissionsForPersonRequest($person_id)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPermissionsInternalGroupsGroupIdRequest($group_id)
    {
