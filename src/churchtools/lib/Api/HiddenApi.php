...
class HiddenApi
{
     ...
     */
    protected function deleteSyncExternalsystemsExternalSystemIdJobconfigsJobIdRequest($external_system_id, $job_id)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function deleteSyncExternalsystemsIdRequest($id)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function deleteSyncFieldMappingsRequest($id, $domain_type)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getGroupsGroupIdMeetingsMeetingIdMembersRequest($group_id, $meeting_id)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getSyncAdaptersRequest()
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getSyncExternalsystemsRequest()
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getSyncExternalsystemsExternalSystemIdJobconfigsJobIdRequest($external_system_id, $job_id)
    {
        // verify the required parameter 'external_system_id' is set
        if ($external_system_id === null || (is_array($external_system_id) && count($external_system_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getSyncExternalsystemsExternalSystemIdJobconfigurationsRequest($external_system_id)
    {
        // verify the required parameter 'external_system_id' is set
        if ($external_system_id === null || (is_array($external_system_id) && count($external_system_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getSyncExternalsystemsIdRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
    ...
    /**
     * Operation getSyncExternalsystemsIdTest
     *
     * Your GET endpoint
     *
     ...
     * @return void
     */
    public function getSyncExternalsystemsIdTest($id)
    {
        $this->getSyncExternalsystemsIdTestWithHttpInfo($id);
    }

    /**
     * Operation getSyncExternalsystemsIdTestWithHttpInfo
     *
     * Your GET endpoint
     *
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSyncExternalsystemsIdTestWithHttpInfo($id)
    {
        $returnType = '';
        $request = $this->getSyncExternalsystemsIdTestRequest($id);
    ...
    /**
     * Operation getSyncExternalsystemsIdTestAsync
     *
     * Your GET endpoint
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSyncExternalsystemsIdTestAsync($id)
    {
        return $this->getSyncExternalsystemsIdTestAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getSyncExternalsystemsIdTestAsyncWithHttpInfo
     *
     * Your GET endpoint
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSyncExternalsystemsIdTestAsyncWithHttpInfo($id)
    {
        $returnType = '';
        $request = $this->getSyncExternalsystemsIdTestRequest($id);
    ...
    /**
     * Create request for operation 'getSyncExternalsystemsIdTest'
     *
     * @param  string $id (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getSyncExternalsystemsIdTestRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling getSyncExternalsystemsIdTest'
            );
        }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getSyncJobconfigsRequest($external_system_ids = null)
    {
        ...
        if ($external_system_ids !== null) {
            $queryParams['external_system_ids'] = ObjectSerializer::toQueryValue($external_system_ids, null);
        }
     ...
     *
     * @param  string $external_system_id external_system_id (required)
     * @param  \StevenBuehner\ChurchTools\Model\JobConfiguration1 $body body (optional)
     *
     * @throws \StevenBuehner\ChurchTools\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \StevenBuehner\ChurchTools\Model\InlineResponse2014
     */
    public function postSyncExternalsystemsExternalSystemIdJobconfigs($external_system_id, $body = null)
    {
        list($response) = $this->postSyncExternalsystemsExternalSystemIdJobconfigsWithHttpInfo($external_system_id, $body);
        return $response;
    }
     ...
     *
     * @param  string $external_system_id (required)
     * @param  \StevenBuehner\ChurchTools\Model\JobConfiguration1 $body (optional)
     *
     * @throws \StevenBuehner\ChurchTools\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \StevenBuehner\ChurchTools\Model\InlineResponse2014, HTTP status code, HTTP response headers (array of strings)
     */
    public function postSyncExternalsystemsExternalSystemIdJobconfigsWithHttpInfo($external_system_id, $body = null)
    {
        $returnType = '\StevenBuehner\ChurchTools\Model\InlineResponse2014';
        $request = $this->postSyncExternalsystemsExternalSystemIdJobconfigsRequest($external_system_id, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postSyncExternalsystemsExternalSystemIdJobconfigsAsync($external_system_id, $body = null)
    {
        return $this->postSyncExternalsystemsExternalSystemIdJobconfigsAsyncWithHttpInfo($external_system_id, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postSyncExternalsystemsExternalSystemIdJobconfigsAsyncWithHttpInfo($external_system_id, $body = null)
    {
        $returnType = '\StevenBuehner\ChurchTools\Model\InlineResponse2014';
        $request = $this->postSyncExternalsystemsExternalSystemIdJobconfigsRequest($external_system_id, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postSyncExternalsystemsExternalSystemIdJobconfigsRequest($external_system_id, $body = null)
    {
        // verify the required parameter 'external_system_id' is set
        if ($external_system_id === null || (is_array($external_system_id) && count($external_system_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postSyncExternalsystemsIdTestRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @param  string $external_system_id external_system_id (required)
     * @param  string $job_id job_id (required)
     * @param  \StevenBuehner\ChurchTools\Model\JobConfiguration2 $body body (optional)
     *
     * @throws \StevenBuehner\ChurchTools\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \StevenBuehner\ChurchTools\Model\InlineResponse200100
     */
    public function putSyncExternalsystemsExternalSystemIdJobconfigs($external_system_id, $job_id, $body = null)
    {
        list($response) = $this->putSyncExternalsystemsExternalSystemIdJobconfigsWithHttpInfo($external_system_id, $job_id, $body);
        return $response;
    }
     ...
     * @param  string $external_system_id (required)
     * @param  string $job_id (required)
     * @param  \StevenBuehner\ChurchTools\Model\JobConfiguration2 $body (optional)
     *
     * @throws \StevenBuehner\ChurchTools\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function putSyncExternalsystemsExternalSystemIdJobconfigsWithHttpInfo($external_system_id, $job_id, $body = null)
    {
        $returnType = '\StevenBuehner\ChurchTools\Model\InlineResponse200100';
        $request = $this->putSyncExternalsystemsExternalSystemIdJobconfigsRequest($external_system_id, $job_id, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putSyncExternalsystemsExternalSystemIdJobconfigsAsync($external_system_id, $job_id, $body = null)
    {
        return $this->putSyncExternalsystemsExternalSystemIdJobconfigsAsyncWithHttpInfo($external_system_id, $job_id, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putSyncExternalsystemsExternalSystemIdJobconfigsAsyncWithHttpInfo($external_system_id, $job_id, $body = null)
    {
        $returnType = '\StevenBuehner\ChurchTools\Model\InlineResponse200100';
        $request = $this->putSyncExternalsystemsExternalSystemIdJobconfigsRequest($external_system_id, $job_id, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function putSyncExternalsystemsExternalSystemIdJobconfigsRequest($external_system_id, $job_id, $body = null)
    {
        // verify the required parameter 'external_system_id' is set
        if ($external_system_id === null || (is_array($external_system_id) && count($external_system_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     *
     * @param  string $id The id of the external system (required)
     * @param  \StevenBuehner\ChurchTools\Model\ExternalSystem2 $body body (optional)
     *
     * @throws \StevenBuehner\ChurchTools\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function putSyncExternalsystemsId($id, $body = null)
    {
        $this->putSyncExternalsystemsIdWithHttpInfo($id, $body);
    }
     ...
     *
     * @param  string $id The id of the external system (required)
     * @param  \StevenBuehner\ChurchTools\Model\ExternalSystem2 $body (optional)
     *
     * @throws \StevenBuehner\ChurchTools\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function putSyncExternalsystemsIdWithHttpInfo($id, $body = null)
    {
        $returnType = '';
        $request = $this->putSyncExternalsystemsIdRequest($id, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putSyncExternalsystemsIdAsync($id, $body = null)
    {
        return $this->putSyncExternalsystemsIdAsyncWithHttpInfo($id, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putSyncExternalsystemsIdAsyncWithHttpInfo($id, $body = null)
    {
        $returnType = '';
        $request = $this->putSyncExternalsystemsIdRequest($id, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function putSyncExternalsystemsIdRequest($id, $body = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
