...
/**
 * GetMasterDataPerson200ResponseDataFollowUpsInner Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  StevenBuehner\ChurchTools
 ...
 */
class GetMasterDataPerson200ResponseDataFollowUpsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getMasterDataPerson_200_response_data_followUps_inner';
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling GetMasterDataPerson200ResponseDataFollowUpsInner., must be bigger than or equal to 1.');
        }
    ...
    public function setNameTranslated($name_translated)
    {
        ...
        if ((mb_strlen($name_translated) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name_translated when calling GetMasterDataPerson200ResponseDataFollowUpsInner., must be bigger than or equal to 1.');
        }
