...
/**
 * CampusesIdPerson Class Doc Comment
 *
 * @category Class
 ...
 */
class CampusesIdPerson implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_campuses__id__person';
    ...
    public function setDomainIdentifier($domain_identifier)
    {
        ...
        if ((mb_strlen($domain_identifier) < 1)) {
            throw new \InvalidArgumentException('invalid length for $domain_identifier when calling CampusesIdPerson., must be bigger than or equal to 1.');
        }
