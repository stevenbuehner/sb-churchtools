...
/**
 * InlineResponse200122Address Class Doc Comment
 *
 * @category Class
 * @package  StevenBuehner\ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse200122Address implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_122_address';
    ...
    public function setStreet($street)
    {
        ...
        if ((mb_strlen($street) < 1)) {
            throw new \InvalidArgumentException('invalid length for $street when calling InlineResponse200122Address., must be bigger than or equal to 1.');
        }
    ...
    public function setAddition($addition)
    {
        ...
        if ((mb_strlen($addition) < 1)) {
            throw new \InvalidArgumentException('invalid length for $addition when calling InlineResponse200122Address., must be bigger than or equal to 1.');
        }
    ...
    public function setDistrict($district)
    {
        ...
        if ((mb_strlen($district) < 1)) {
            throw new \InvalidArgumentException('invalid length for $district when calling InlineResponse200122Address., must be bigger than or equal to 1.');
        }
    ...
    public function setZip($zip)
    {
        ...
        if ((mb_strlen($zip) < 1)) {
            throw new \InvalidArgumentException('invalid length for $zip when calling InlineResponse200122Address., must be bigger than or equal to 1.');
        }
    ...
    public function setCity($city)
    {
        ...
        if ((mb_strlen($city) < 1)) {
            throw new \InvalidArgumentException('invalid length for $city when calling InlineResponse200122Address., must be bigger than or equal to 1.');
        }
