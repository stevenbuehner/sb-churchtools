...
/**
 * GetPersonMasterdata200ResponseDataCampusesInnerMeta Class Doc Comment
 *
 * @category Class
 * @package  StevenBuehner\ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class GetPersonMasterdata200ResponseDataCampusesInnerMeta implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getPersonMasterdata_200_response_data_campuses_inner_meta';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['created_date']) && !preg_match("/^[0-9]{4}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}:[0-9]{2}Z$/", $this->container['created_date'])) {
            $invalidProperties[] = "invalid value for 'created_date', must be conform to the pattern /^[0-9]{4}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}:[0-9]{2}Z$/.";
        }

        if (!is_null($this->container['modified_date']) && !preg_match("/^[0-9]{4}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}:[0-9]{2}Z$/", $this->container['modified_date'])) {
            $invalidProperties[] = "invalid value for 'modified_date', must be conform to the pattern /^[0-9]{4}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}:[0-9]{2}Z$/.";
        }
    ...
    public function setCreatedDate($created_date)
    {
        ...
        if (!is_null($created_date) && (!preg_match("/^[0-9]{4}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}:[0-9]{2}Z$/", $created_date))) {
            throw new \InvalidArgumentException("invalid value for $created_date when calling GetPersonMasterdata200ResponseDataCampusesInnerMeta., must conform to the pattern /^[0-9]{4}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}:[0-9]{2}Z$/.");
        }
    ...
    public function setModifiedDate($modified_date)
    {
        ...
        if (!is_null($modified_date) && (!preg_match("/^[0-9]{4}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}:[0-9]{2}Z$/", $modified_date))) {
            throw new \InvalidArgumentException("invalid value for $modified_date when calling GetPersonMasterdata200ResponseDataCampusesInnerMeta., must conform to the pattern /^[0-9]{4}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}:[0-9]{2}Z$/.");
        }
