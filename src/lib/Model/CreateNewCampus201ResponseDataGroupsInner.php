<?php
/**
 * CreateNewCampus201ResponseDataGroupsInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * CreateNewCampus201ResponseDataGroupsInner Class Doc Comment
 *
 * @category Class
 * @package  StevenBuehner\ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class CreateNewCampus201ResponseDataGroupsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createNewCampus_201_response_data_groups_inner';
    ...
    public function setGroupHomepageApi($group_homepage_api)
    {
        ...
        if ((mb_strlen($group_homepage_api) < 1)) {
            throw new \InvalidArgumentException('invalid length for $group_homepage_api when calling CreateNewCampus201ResponseDataGroupsInner., must be bigger than or equal to 1.');
        }
    ...
    public function setGroupHomepageUrl($group_homepage_url)
    {
        ...
        if ((mb_strlen($group_homepage_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $group_homepage_url when calling CreateNewCampus201ResponseDataGroupsInner., must be bigger than or equal to 1.');
        }
