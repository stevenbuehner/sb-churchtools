...
/**
 * GetAllCampuses200ResponseDataInnerServicesInner Class Doc Comment
 *
 * @category Class
 * @package  StevenBuehner\ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class GetAllCampuses200ResponseDataInnerServicesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getAllCampuses_200_response_data_inner_services_inner';
    ...
    */
    ...
    public function setRepetition($repetition)
    {
        ...
        if ((mb_strlen($repetition) < 1)) {
            throw new \InvalidArgumentException('invalid length for $repetition when calling GetAllCampuses200ResponseDataInnerServicesInner., must be bigger than or equal to 1.');
        }
    ...
    public function setTime($time)
    {
        ...
        if ((mb_strlen($time) < 1)) {
            throw new \InvalidArgumentException('invalid length for $time when calling GetAllCampuses200ResponseDataInnerServicesInner., must be bigger than or equal to 1.');
        }
