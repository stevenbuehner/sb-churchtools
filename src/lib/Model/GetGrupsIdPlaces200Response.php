...
class GetGrupsIdPlaces200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setCity($city)
    {
        ...
        if ((mb_strlen($city) < 1)) {
            throw new \InvalidArgumentException('invalid length for $city when calling GetGrupsIdPlaces200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setGeoLat($geo_lat)
    {
        ...
        if ((mb_strlen($geo_lat) < 1)) {
            throw new \InvalidArgumentException('invalid length for $geo_lat when calling GetGrupsIdPlaces200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setGeoLng($geo_lng)
    {
        ...
        if ((mb_strlen($geo_lng) < 1)) {
            throw new \InvalidArgumentException('invalid length for $geo_lng when calling GetGrupsIdPlaces200Response., must be bigger than or equal to 1.');
        }
