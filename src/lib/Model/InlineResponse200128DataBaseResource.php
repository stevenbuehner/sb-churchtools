<?php
/**
 * InlineResponse200128DataBaseResource
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * InlineResponse200128DataBaseResource Class Doc Comment
 *
 * @category Class
 * @package  StevenBuehner\ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse200128DataBaseResource implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_128_data_base_resource';
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineResponse200128DataBaseResource., must be bigger than or equal to 1.');
        }
    ...
    public function setNameTranslated($name_translated)
    {
        ...
        if ((mb_strlen($name_translated) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name_translated when calling InlineResponse200128DataBaseResource., must be bigger than or equal to 1.');
        }
    ...
    public function setRandomString($random_string)
    {
        ...
        if ((mb_strlen($random_string) < 1)) {
            throw new \InvalidArgumentException('invalid length for $random_string when calling InlineResponse200128DataBaseResource., must be bigger than or equal to 1.');
        }
