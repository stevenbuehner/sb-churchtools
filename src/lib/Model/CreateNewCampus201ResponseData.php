...
/**
 * CreateNewCampus201ResponseData Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateNewCampus201ResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createNewCampus_201_response_data';
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) < 0)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CreateNewCampus201ResponseData., must be bigger than or equal to 0.');
        }
    ...
    public function setEmail($email)
    {
        ...
        if ((mb_strlen($email) < 1)) {
            throw new \InvalidArgumentException('invalid length for $email when calling CreateNewCampus201ResponseData., must be bigger than or equal to 1.');
        }
    ...
    public function setFinderUrl($finder_url)
    {
        ...
        if ((mb_strlen($finder_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $finder_url when calling CreateNewCampus201ResponseData., must be bigger than or equal to 1.');
        }
    ...
    public function setGallery($gallery)
    {
        ...
        if ((count($gallery) < 0)) {
            throw new \InvalidArgumentException('invalid length for $gallery when calling CreateNewCampus201ResponseData., number of items must be greater than or equal to 0.');
        }
    ...
    public function setGroups($groups)
    {
        ...
        if ((count($groups) < 0)) {
            throw new \InvalidArgumentException('invalid length for $groups when calling CreateNewCampus201ResponseData., number of items must be greater than or equal to 0.');
        }
    ...
    public function setGuid($guid)
    {
        ...
        if ((mb_strlen($guid) < 1)) {
            throw new \InvalidArgumentException('invalid length for $guid when calling CreateNewCampus201ResponseData., must be bigger than or equal to 1.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateNewCampus201ResponseData., must be bigger than or equal to 1.');
        }
    ...
    public function setNameTranslated($name_translated)
    {
        ...
        if ((mb_strlen($name_translated) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name_translated when calling CreateNewCampus201ResponseData., must be bigger than or equal to 1.');
        }
    ...
    public function setPhone($phone)
    {
        ...
        if ((mb_strlen($phone) < 1)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling CreateNewCampus201ResponseData., must be bigger than or equal to 1.');
        }
    ...
    public function setProfileType($profile_type)
    {
        ...
        if ((mb_strlen($profile_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $profile_type when calling CreateNewCampus201ResponseData., must be bigger than or equal to 1.');
        }
    ...
    public function setServiceBanner($service_banner)
    {
        ...
        if ((mb_strlen($service_banner) < 1)) {
            throw new \InvalidArgumentException('invalid length for $service_banner when calling CreateNewCampus201ResponseData., must be bigger than or equal to 1.');
        }
    ...
    public function setServices($services)
    {
        ...
        if ((count($services) < 0)) {
            throw new \InvalidArgumentException('invalid length for $services when calling CreateNewCampus201ResponseData., number of items must be greater than or equal to 0.');
        }
    ...
    public function setShortName($short_name)
    {
        ...
        if ((mb_strlen($short_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $short_name when calling CreateNewCampus201ResponseData., must be bigger than or equal to 0.');
        }
    ...
    public function setShorty($shorty)
    {
        ...
        if ((mb_strlen($shorty) < 1)) {
            throw new \InvalidArgumentException('invalid length for $shorty when calling CreateNewCampus201ResponseData., must be bigger than or equal to 1.');
        }
    ...
    public function setSlug($slug)
    {
        ...
        if ((mb_strlen($slug) < 1)) {
            throw new \InvalidArgumentException('invalid length for $slug when calling CreateNewCampus201ResponseData., must be bigger than or equal to 1.');
        }
    ...
    public function setTeam($team)
    {
        ...
        if ((count($team) < 0)) {
            throw new \InvalidArgumentException('invalid length for $team when calling CreateNewCampus201ResponseData., number of items must be greater than or equal to 0.');
        }
    ...
    public function setTeamTitle($team_title)
    {
        ...
        if ((mb_strlen($team_title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $team_title when calling CreateNewCampus201ResponseData., must be bigger than or equal to 1.');
        }
    ...
    public function setWebsite($website)
    {
        ...
        if ((mb_strlen($website) < 1)) {
            throw new \InvalidArgumentException('invalid length for $website when calling CreateNewCampus201ResponseData., must be bigger than or equal to 1.');
        }
