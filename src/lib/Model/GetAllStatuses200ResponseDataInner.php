<?php
/**
 * GetAllStatuses200ResponseDataInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetAllStatuses200ResponseDataInner Class Doc Comment
 *
 * @category Class
 * @package  StevenBuehner\ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class GetAllStatuses200ResponseDataInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getAllStatuses_200_response_data_inner';
     ...
     * Sets id
     *
     * @param int|null $id ID of status
     *
     * @return self
     */
     ...
     * Sets is_member
     *
     * @param bool|null $is_member Flag if status is member of the church
     *
     * @return self
     */
     ...
     * Sets is_searchable
     *
     * @param bool|null $is_searchable Flag if that status is searchable
     *
     * @return self
     */
     ...
     *
     * @param int|null $security_level_id Only persons with that securitylevel can edit/select/delete that status
     *
     * @return self
     */
