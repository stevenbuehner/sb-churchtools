<?php
/**
 * InlineResponse200128DataAppointmentBase
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * InlineResponse200128DataAppointmentBase Class Doc Comment
 *
 * @category Class
 * @package  StevenBuehner\ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse200128DataAppointmentBase implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_128_data_appointment_base';
    ...
    protected static $openAPITypes = [
        ...
        'note' => 'string',
        'version' => 'float',
        'calendar' => '\StevenBuehner\ChurchTools\Model\InlineResponse200128DataAppointmentBaseCalendar',
        'information' => 'string',
        'link' => 'string',
        'is_internal' => 'bool',
        'start_date' => '\DateTime',
        ...
        'additions' => 'object[]',
        'exceptions' => 'object[]',
        'signup' => '\StevenBuehner\ChurchTools\Model\InlineResponse200128DataAppointmentBaseSignup',
        'meta' => '\StevenBuehner\ChurchTools\Model\InlineResponse200128DataAppointmentBaseMeta'
    ];
    ...
    public function setCaption($caption)
    {
        ...
        if ((mb_strlen($caption) < 1)) {
            throw new \InvalidArgumentException('invalid length for $caption when calling InlineResponse200128DataAppointmentBase., must be bigger than or equal to 1.');
        }
     ...
     * Gets calendar
     *
     * @return \StevenBuehner\ChurchTools\Model\InlineResponse200128DataAppointmentBaseCalendar
     */
     ...
     * Sets calendar
     *
     * @param \StevenBuehner\ChurchTools\Model\InlineResponse200128DataAppointmentBaseCalendar $calendar calendar
     *
     * @return self
     */
    ...
    public function setStartDate($start_date)
    {
        ...
        if ((mb_strlen($start_date) < 1)) {
            throw new \InvalidArgumentException('invalid length for $start_date when calling InlineResponse200128DataAppointmentBase., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/2022-03-16T18:00:00.000000Z/", $start_date))) {
            throw new \InvalidArgumentException("invalid value for $start_date when calling InlineResponse200128DataAppointmentBase., must conform to the pattern /2022-03-16T18:00:00.000000Z/.");
        }
    ...
    public function setEndDate($end_date)
    {
        ...
        if ((mb_strlen($end_date) < 1)) {
            throw new \InvalidArgumentException('invalid length for $end_date when calling InlineResponse200128DataAppointmentBase., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/2022-03-16T18:00:00.000000Z/", $end_date))) {
            throw new \InvalidArgumentException("invalid value for $end_date when calling InlineResponse200128DataAppointmentBase., must conform to the pattern /2022-03-16T18:00:00.000000Z/.");
        }
    ...
    public function setRepeatUntil($repeat_until)
    {
        ...
        if (!is_null($repeat_until) && (!preg_match("/2022-03-16T18:00:00.000000Z/", $repeat_until))) {
            throw new \InvalidArgumentException("invalid value for $repeat_until when calling InlineResponse200128DataAppointmentBase., must conform to the pattern /2022-03-16T18:00:00.000000Z/.");
        }
     ...
     * Gets signup
     *
     * @return \StevenBuehner\ChurchTools\Model\InlineResponse200128DataAppointmentBaseSignup
     */
     ...
     * Sets signup
     *
     * @param \StevenBuehner\ChurchTools\Model\InlineResponse200128DataAppointmentBaseSignup $signup signup
     *
     * @return self
     */
     ...
     * Gets meta
     *
     * @return \StevenBuehner\ChurchTools\Model\InlineResponse200128DataAppointmentBaseMeta
     */
     ...
     * Sets meta
     *
     * @param \StevenBuehner\ChurchTools\Model\InlineResponse200128DataAppointmentBaseMeta $meta meta
     *
     * @return self
     */
