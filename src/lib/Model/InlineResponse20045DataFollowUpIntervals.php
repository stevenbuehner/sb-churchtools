...
/**
 * InlineResponse20045DataFollowUpIntervals Class Doc Comment
 *
 * @category Class
 * @package  StevenBuehner\ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse20045DataFollowUpIntervals implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_45_data_followUpIntervals';
    ...
    public function setInfo($info)
    {
        ...
        if ((mb_strlen($info) < 1)) {
            throw new \InvalidArgumentException('invalid length for $info when calling InlineResponse20045DataFollowUpIntervals., must be bigger than or equal to 1.');
        }
