...
/**
 * GetCalendarsCalendarIdAppointmentsAppointmentIdStartDate200ResponseDataGroup Class Doc Comment
 *
 * @category Class
 * @package  StevenBuehner\ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class GetCalendarsCalendarIdAppointmentsAppointmentIdStartDate200ResponseDataGroup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_calendars_calendarId_appointments_appointmentId_startDate_200_response_data_group';
    ...
    */
    ...
    public function setDomainIdentifier($domain_identifier)
    {
        ...
        if ((mb_strlen($domain_identifier) < 1)) {
            throw new \InvalidArgumentException('invalid length for $domain_identifier when calling GetCalendarsCalendarIdAppointmentsAppointmentIdStartDate200ResponseDataGroup., must be bigger than or equal to 1.');
        }
    ...
    public function setFrontendUrl($frontend_url)
    {
        ...
        if ((mb_strlen($frontend_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $frontend_url when calling GetCalendarsCalendarIdAppointmentsAppointmentIdStartDate200ResponseDataGroup., must be bigger than or equal to 1.');
        }
    ...
    public function setIcon($icon)
    {
        ...
        if ((mb_strlen($icon) < 1)) {
            throw new \InvalidArgumentException('invalid length for $icon when calling GetCalendarsCalendarIdAppointmentsAppointmentIdStartDate200ResponseDataGroup., must be bigger than or equal to 1.');
        }
