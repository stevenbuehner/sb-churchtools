 ...
 */
class InlineResponse20099Data implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_99_data';
    ...
    protected static $openAPITypes = [
        ...
        'domain_type' => 'string',
        'properties' => '\StevenBuehner\ChurchTools\Model\InlineResponse20099DataProperties'
    ];
    ...
    public function setDomainType($domain_type)
    {
        ...
        if ((mb_strlen($domain_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $domain_type when calling InlineResponse20099Data., must be bigger than or equal to 1.');
        }
     ...
     * Gets properties
     *
     * @return \StevenBuehner\ChurchTools\Model\InlineResponse20099DataProperties
     */
     ...
     * Sets properties
     *
     * @param \StevenBuehner\ChurchTools\Model\InlineResponse20099DataProperties $properties properties
     *
     * @return self
     */
