...
class Widget implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['empty_strategy'] = $data['empty_strategy'] ?? null;
        $this->container['empty_text'] = $data['empty_text'] ?? null;
        $this->container['filter'] = $data['filter'] ?? null;
        $this->container['items'] = $data['items'] ?? null;
        $this->container['key'] = $data['key'] ?? null;
        $this->container['title'] = $data['title'] ?? null;
        $this->container['widget_settings'] = $data['widget_settings'] ?? null;
