...
/**
 * GetCalendarsCalendarIdAppointmentsAppointmentIdStartDate200ResponseDataMeetingRequestsInnerPerson Class Doc Comment
 *
 * @category Class
 * @package  StevenBuehner\ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class GetCalendarsCalendarIdAppointmentsAppointmentIdStartDate200ResponseDataMeetingRequestsInnerPerson implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_calendars_calendarId_appointments_appointmentId_startDate_200_response_data_meetingRequests_inner_person';
    ...
    public function setApiUrl($api_url)
    {
        ...
        if ((mb_strlen($api_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $api_url when calling GetCalendarsCalendarIdAppointmentsAppointmentIdStartDate200ResponseDataMeetingRequestsInnerPerson., must be bigger than or equal to 1.');
        }
    ...
    public function setDomainIdentifier($domain_identifier)
    {
        ...
        if ((mb_strlen($domain_identifier) < 1)) {
            throw new \InvalidArgumentException('invalid length for $domain_identifier when calling GetCalendarsCalendarIdAppointmentsAppointmentIdStartDate200ResponseDataMeetingRequestsInnerPerson., must be bigger than or equal to 1.');
        }
    ...
    public function setDomainType($domain_type)
    {
        ...
        if ((mb_strlen($domain_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $domain_type when calling GetCalendarsCalendarIdAppointmentsAppointmentIdStartDate200ResponseDataMeetingRequestsInnerPerson., must be bigger than or equal to 1.');
        }
    ...
    public function setFrontendUrl($frontend_url)
    {
        ...
        if ((mb_strlen($frontend_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $frontend_url when calling GetCalendarsCalendarIdAppointmentsAppointmentIdStartDate200ResponseDataMeetingRequestsInnerPerson., must be bigger than or equal to 1.');
        }
    ...
    public function setIcon($icon)
    {
        ...
        if ((mb_strlen($icon) < 1)) {
            throw new \InvalidArgumentException('invalid length for $icon when calling GetCalendarsCalendarIdAppointmentsAppointmentIdStartDate200ResponseDataMeetingRequestsInnerPerson., must be bigger than or equal to 1.');
        }
    ...
    public function setImageUrl($image_url)
    {
        ...
        if ((mb_strlen($image_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $image_url when calling GetCalendarsCalendarIdAppointmentsAppointmentIdStartDate200ResponseDataMeetingRequestsInnerPerson., must be bigger than or equal to 1.');
        }
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling GetCalendarsCalendarIdAppointmentsAppointmentIdStartDate200ResponseDataMeetingRequestsInnerPerson., must be bigger than or equal to 1.');
        }
