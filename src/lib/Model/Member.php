...
class Member implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_member';
    ...
    */
    ...
    public function setWaitinglistPos($waitinglist_pos)
    {
        if (is_null($waitinglist_pos)) {
            array_push($this->openAPINullablesSetToNull, 'waitinglist_pos');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('waitinglist_pos', $nullablesSetToNull);
            if ($index !== FALSE) {
