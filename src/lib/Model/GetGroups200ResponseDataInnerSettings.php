...
class GetGroups200ResponseDataInnerSettings implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'is_public' => 'bool',
        'new_member' => '\StevenBuehner\ChurchTools\Model\GetGroups200ResponseDataInnerSettingsNewMember',
    ...
    */
     ...
     * Gets new_member
     *
     * @return \StevenBuehner\ChurchTools\Model\GetGroups200ResponseDataInnerSettingsNewMember|null
     */
     ...
     * Sets new_member
     *
     * @param \StevenBuehner\ChurchTools\Model\GetGroups200ResponseDataInnerSettingsNewMember|null $new_member new_member
     *
     * @return self
     */
    public function setNewMember($new_member)
    {
        ...
        if (is_null($new_member)) {
            array_push($this->openAPINullablesSetToNull, 'new_member');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('new_member', $nullablesSetToNull);
            if ($index !== FALSE) {
