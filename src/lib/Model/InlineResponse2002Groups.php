...
/**
 * InlineResponse2002Groups Class Doc Comment
 *
 * @category Class
 * @package  StevenBuehner\ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse2002Groups implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_2_groups';
    ...
    public function setGroupHomepageUrl($group_homepage_url)
    {
        ...
        if ((mb_strlen($group_homepage_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $group_homepage_url when calling InlineResponse2002Groups., must be bigger than or equal to 1.');
        }
    ...
    public function setGroupHomepageApi($group_homepage_api)
    {
        ...
        if ((mb_strlen($group_homepage_api) < 1)) {
            throw new \InvalidArgumentException('invalid length for $group_homepage_api when calling InlineResponse2002Groups., must be bigger than or equal to 1.');
        }
