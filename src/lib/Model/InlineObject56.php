...
class InlineObject56 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setPropertyMappingsMasterToEs($property_mappings_master_to_es)
    {
        ...
        if ((count($property_mappings_master_to_es) < 1)) {
            throw new \InvalidArgumentException('invalid length for $property_mappings_master_to_es when calling InlineObject56., number of items must be greater than or equal to 1.');
        }
    ...
    public function setPropertyMappingsEstoMaster($property_mappings_esto_master)
    {
        ...
        if ((count($property_mappings_esto_master) < 1)) {
            throw new \InvalidArgumentException('invalid length for $property_mappings_esto_master when calling InlineObject56., number of items must be greater than or equal to 1.');
        }
