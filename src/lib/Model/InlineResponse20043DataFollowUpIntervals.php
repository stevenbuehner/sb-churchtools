<?php
/**
 * InlineResponse20043DataFollowUpIntervals
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * InlineResponse20043DataFollowUpIntervals Class Doc Comment
 *
 * @category Class
 * @package  StevenBuehner\ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse20043DataFollowUpIntervals implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_43_data_followUpIntervals';
    ...
    public function setInfo($info)
    {
        ...
        if ((mb_strlen($info) < 1)) {
            throw new \InvalidArgumentException('invalid length for $info when calling InlineResponse20043DataFollowUpIntervals., must be bigger than or equal to 1.');
        }
