...
/**
 * CampusesIdServices Class Doc Comment
 *
 * @category Class
 * @package  StevenBuehner\ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class CampusesIdServices implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_campuses__id__services';
    ...
    public function setRepetition($repetition)
    {
        ...
        if ((mb_strlen($repetition) < 1)) {
            throw new \InvalidArgumentException('invalid length for $repetition when calling CampusesIdServices., must be bigger than or equal to 1.');
        }
    ...
    public function setTime($time)
    {
        ...
        if ((mb_strlen($time) < 1)) {
            throw new \InvalidArgumentException('invalid length for $time when calling CampusesIdServices., must be bigger than or equal to 1.');
        }
    ...
    public function setNote($note)
    {
        ...
        if ((mb_strlen($note) < 1)) {
            throw new \InvalidArgumentException('invalid length for $note when calling CampusesIdServices., must be bigger than or equal to 1.');
        }
