 ...
 */
class InlineResponse200102Data implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_102_data';
    ...
    protected static $openAPITypes = [
        ...
        'domain_type' => 'string',
        'properties' => '\StevenBuehner\ChurchTools\Model\InlineResponse200102DataProperties'
    ];
    ...
    public function setDomainType($domain_type)
    {
        ...
        if ((mb_strlen($domain_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $domain_type when calling InlineResponse200102Data., must be bigger than or equal to 1.');
        }
     ...
     * Gets properties
     *
     * @return \StevenBuehner\ChurchTools\Model\InlineResponse200102DataProperties
     */
     ...
     * Sets properties
     *
     * @param \StevenBuehner\ChurchTools\Model\InlineResponse200102DataProperties $properties properties
     *
     * @return self
     */
