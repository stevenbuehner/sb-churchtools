...
/**
 * InlineResponse20046DataAccountClasses Class Doc Comment
 *
 * @category Class
 * @package  StevenBuehner\ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse20046DataAccountClasses implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_46_data_accountClasses';
     ...
     *
     * @param bool|null $include_profit_loss If true, an additional row is added to that class in the report, which lists the profit-loss sum.
     *
     * @return self
     */
