...
/**
 * InlineResponse4091Data Class Doc Comment
 *
 * @category Class
 * @package  StevenBuehner\ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse4091Data implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_409_1_data';
    ...
    public function setMessage($message)
    {
        ...
        if ((mb_strlen($message) < 1)) {
            throw new \InvalidArgumentException('invalid length for $message when calling InlineResponse4091Data., must be bigger than or equal to 1.');
        }
    ...
    public function setTranslatedMessage($translated_message)
    {
        ...
        if ((mb_strlen($translated_message) < 1)) {
            throw new \InvalidArgumentException('invalid length for $translated_message when calling InlineResponse4091Data., must be bigger than or equal to 1.');
        }
    ...
    public function setMessageKey($message_key)
    {
        ...
        if ((mb_strlen($message_key) < 1)) {
            throw new \InvalidArgumentException('invalid length for $message_key when calling InlineResponse4091Data., must be bigger than or equal to 1.');
        }
