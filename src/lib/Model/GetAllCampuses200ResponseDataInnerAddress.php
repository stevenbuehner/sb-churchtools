...
class GetAllCampuses200ResponseDataInnerAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['addition'] === null && !$this->isNullableSetToNull('addition')) {
            $invalidProperties[] = "'addition' can't be null";
        }
        if ($this->container['city'] === null && !$this->isNullableSetToNull('city')) {
            $invalidProperties[] = "'city' can't be null";
        }
        if ($this->container['district'] === null && !$this->isNullableSetToNull('district')) {
        ...
        if ($this->container['meeting_at'] === null && !$this->isNullableSetToNull('meeting_at')) {
     ...
     * Sets meeting_at
     *
     * @param string|null $meeting_at meeting_at
     *
     * @return self
     */
