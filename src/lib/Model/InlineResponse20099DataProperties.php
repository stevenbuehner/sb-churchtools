<?php
/**
 * InlineResponse20099DataProperties
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * InlineResponse20099DataProperties Class Doc Comment
 *
 * @category Class
 * @package  StevenBuehner\ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse20099DataProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_99_data_properties';
    ...
    protected static $openAPITypes = [
        'property_mappings_master_to_es' => '\StevenBuehner\ChurchTools\Model\InlineResponse20099DataPropertiesPropertyMappingsMasterToES[]',
        'property_mappings_esto_master' => '\StevenBuehner\ChurchTools\Model\InlineResponse20099DataPropertiesPropertyMappingsMasterToES[]'
    ];
     ...
     *
     * @return \StevenBuehner\ChurchTools\Model\InlineResponse20099DataPropertiesPropertyMappingsMasterToES[]
     */
     ...
     *
     * @param \StevenBuehner\ChurchTools\Model\InlineResponse20099DataPropertiesPropertyMappingsMasterToES[] $property_mappings_master_to_es property_mappings_master_to_es
     *
     * @return self
     */
    public function setPropertyMappingsMasterToEs($property_mappings_master_to_es)
    {
        ...
        if ((count($property_mappings_master_to_es) < 1)) {
            throw new \InvalidArgumentException('invalid length for $property_mappings_master_to_es when calling InlineResponse20099DataProperties., number of items must be greater than or equal to 1.');
        }
     ...
     *
     * @param \StevenBuehner\ChurchTools\Model\InlineResponse20099DataPropertiesPropertyMappingsMasterToES[] $property_mappings_esto_master property_mappings_esto_master
     *
     * @return self
     */
    public function setPropertyMappingsEstoMaster($property_mappings_esto_master)
    {
        ...
        if ((count($property_mappings_esto_master) < 1)) {
            throw new \InvalidArgumentException('invalid length for $property_mappings_esto_master when calling InlineResponse20099DataProperties., number of items must be greater than or equal to 1.');
        }
