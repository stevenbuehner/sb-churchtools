...
/**
 * InlineResponse20044DataFollowUps Class Doc Comment
 *
 * @category Class
 * @package  StevenBuehner\ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse20044DataFollowUps implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_44_data_followUps';
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineResponse20044DataFollowUps., must be bigger than or equal to 1.');
        }
    ...
    public function setNameTranslated($name_translated)
    {
        ...
        if ((mb_strlen($name_translated) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name_translated when calling InlineResponse20044DataFollowUps., must be bigger than or equal to 1.');
        }
