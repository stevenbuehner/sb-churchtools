...
/**
 * InlineResponse20045DataGroups Class Doc Comment
 *
 * @category Class
 * @package  StevenBuehner\ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse20045DataGroups implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_45_data_groups';
    ...
    protected static $openAPITypes = [
        'group' => '\StevenBuehner\ChurchTools\Model\GroupDomainObject2',
     ...
     * Sets group
     *
     * @param \StevenBuehner\ChurchTools\Model\GroupDomainObject2|null $group group
     *
     * @return self
     */
    ...
    public function setGroupHomepageUrl($group_homepage_url)
    {
        ...
        if ((mb_strlen($group_homepage_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $group_homepage_url when calling InlineResponse20045DataGroups., must be bigger than or equal to 1.');
        }
    ...
    public function setGroupHomepageApi($group_homepage_api)
    {
        ...
        if ((mb_strlen($group_homepage_api) < 1)) {
            throw new \InvalidArgumentException('invalid length for $group_homepage_api when calling InlineResponse20045DataGroups., must be bigger than or equal to 1.');
        }
