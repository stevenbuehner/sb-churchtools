...
/**
 * PersonMasterDataFollowUpIntervalsInner Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  StevenBuehner\ChurchTools
 ...
 */
class PersonMasterDataFollowUpIntervalsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PersonMasterData_followUpIntervals_inner';
    ...
    public function setInfo($info)
    {
        ...
        if ((mb_strlen($info) < 1)) {
            throw new \InvalidArgumentException('invalid length for $info when calling PersonMasterDataFollowUpIntervalsInner., must be bigger than or equal to 1.');
        }
