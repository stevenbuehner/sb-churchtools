...
/**
 * InlineResponse2002Denomination Class Doc Comment
 *
 * @category Class
 ...
 */
class InlineResponse2002Denomination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_2_denomination';
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineResponse2002Denomination., must be bigger than or equal to 1.');
        }
    ...
    public function setNameTranslated($name_translated)
    {
        ...
        if ((mb_strlen($name_translated) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name_translated when calling InlineResponse2002Denomination., must be bigger than or equal to 1.');
        }
    ...
    public function setKey($key)
    {
        ...
        if ((mb_strlen($key) < 1)) {
            throw new \InvalidArgumentException('invalid length for $key when calling InlineResponse2002Denomination., must be bigger than or equal to 1.');
        }
