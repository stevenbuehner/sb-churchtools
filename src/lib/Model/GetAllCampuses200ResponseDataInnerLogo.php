<?php
/**
 * GetAllCampuses200ResponseDataInnerLogo
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetAllCampuses200ResponseDataInnerLogo Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  StevenBuehner\ChurchTools
 ...
 */
class GetAllCampuses200ResponseDataInnerLogo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getAllCampuses_200_response_data_inner_logo';
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling GetAllCampuses200ResponseDataInnerLogo., must be bigger than or equal to 1.');
        }
    ...
    public function setDomainType($domain_type)
    {
        ...
        if ((mb_strlen($domain_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $domain_type when calling GetAllCampuses200ResponseDataInnerLogo., must be bigger than or equal to 1.');
        }
    ...
    public function setDomainIdentifier($domain_identifier)
    {
        ...
        if ((mb_strlen($domain_identifier) < 1)) {
            throw new \InvalidArgumentException('invalid length for $domain_identifier when calling GetAllCampuses200ResponseDataInnerLogo., must be bigger than or equal to 1.');
        }
    ...
    public function setApiUrl($api_url)
    {
        ...
        if ((mb_strlen($api_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $api_url when calling GetAllCampuses200ResponseDataInnerLogo., must be bigger than or equal to 1.');
        }
    ...
    public function setFrontendUrl($frontend_url)
    {
        ...
        if ((mb_strlen($frontend_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $frontend_url when calling GetAllCampuses200ResponseDataInnerLogo., must be bigger than or equal to 1.');
        }
    ...
    public function setIcon($icon)
    {
        ...
        if ((mb_strlen($icon) < 1)) {
            throw new \InvalidArgumentException('invalid length for $icon when calling GetAllCampuses200ResponseDataInnerLogo., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param object $domain_attributes Additional attributes. Depends on domainType.
     *
     * @return self
     */
