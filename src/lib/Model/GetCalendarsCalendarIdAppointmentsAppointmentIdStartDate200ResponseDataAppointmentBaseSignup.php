...
/**
 * GetCalendarsCalendarIdAppointmentsAppointmentIdStartDate200ResponseDataAppointmentBaseSignup Class Doc Comment
 *
 * @category Class
 * @package  StevenBuehner\ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class GetCalendarsCalendarIdAppointmentsAppointmentIdStartDate200ResponseDataAppointmentBaseSignup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_calendars_calendarId_appointments_appointmentId_startDate_200_response_data_appointment_base_signup';
    ...
    protected static array $openAPINullables = [
        'signup_days_archive_group_no' => false,
		'signup_group_type_id' => false,
		'signup_set_completion_date' => false,
		'signup_template_group_id' => false,
		'singup_days_forward_no' => false
    ];
    ...
    */
    ...
    public function setSignupDaysArchiveGroupNo($signup_days_archive_group_no)
    {
        ...
        if (is_null($signup_days_archive_group_no)) {
            throw new \InvalidArgumentException('non-nullable signup_days_archive_group_no cannot be null');
        }
    ...
    public function setSignupGroupTypeId($signup_group_type_id)
    {
        ...
        if (is_null($signup_group_type_id)) {
            throw new \InvalidArgumentException('non-nullable signup_group_type_id cannot be null');
        }
    ...
    public function setSingupDaysForwardNo($singup_days_forward_no)
    {
        ...
        if (is_null($singup_days_forward_no)) {
            throw new \InvalidArgumentException('non-nullable singup_days_forward_no cannot be null');
        }
