...
class GetPublicgroup200ResponseDataSignUpConditions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
		...
		'requester_role_set_in_group' => false
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('requester_role_set_in_group', $data ?? [], null);
    }
    ...
    */
    ...
    public function setRequesterRoleSetInGroup($requester_role_set_in_group)
    {
        ...
        if (is_null($requester_role_set_in_group)) {
            throw new \InvalidArgumentException('non-nullable requester_role_set_in_group cannot be null');
        }
