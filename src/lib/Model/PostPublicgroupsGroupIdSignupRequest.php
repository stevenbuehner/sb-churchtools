...
class PostPublicgroupsGroupIdSignupRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Gets forms
     *
     * @return \StevenBuehner\ChurchTools\Model\PostPublicgroupsGroupIdSignupRequestFormsInner[]
     */
     ...
     * Sets forms
     *
     * @param \StevenBuehner\ChurchTools\Model\PostPublicgroupsGroupIdSignupRequestFormsInner[] $forms A list of form data containing a form object for each person that should be signed up.
     *
     * @return self
     */
