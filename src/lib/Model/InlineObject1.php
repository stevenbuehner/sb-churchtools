...
class InlineObject1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setShortName($short_name)
    {
        ...
        if ((mb_strlen($short_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $short_name when calling InlineObject1., must be bigger than or equal to 1.');
        }
    ...
    public function setShorty($shorty)
    {
        ...
        if ((mb_strlen($shorty) < 1)) {
            throw new \InvalidArgumentException('invalid length for $shorty when calling InlineObject1., must be bigger than or equal to 1.');
        }
    ...
    public function setSlug($slug)
    {
        ...
        if ((mb_strlen($slug) < 1)) {
            throw new \InvalidArgumentException('invalid length for $slug when calling InlineObject1., must be bigger than or equal to 1.');
        }
    ...
    public function setDescription($description)
    {
        if ((mb_strlen($description) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling InlineObject1., must be smaller than or equal to 1000.');
        }
        if ((mb_strlen($description) < 1)) {
            throw new \InvalidArgumentException('invalid length for $description when calling InlineObject1., must be bigger than or equal to 1.');
        }
    ...
    public function setWebsite($website)
    {
        ...
        if ((mb_strlen($website) < 1)) {
            throw new \InvalidArgumentException('invalid length for $website when calling InlineObject1., must be bigger than or equal to 1.');
        }
    ...
    public function setEmail($email)
    {
        ...
        if ((mb_strlen($email) < 1)) {
            throw new \InvalidArgumentException('invalid length for $email when calling InlineObject1., must be bigger than or equal to 1.');
        }
    ...
    public function setPhone($phone)
    {
        ...
        if ((mb_strlen($phone) < 1)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling InlineObject1., must be bigger than or equal to 1.');
        }
    ...
    public function setGroups($groups)
    {
        ...
        if ((count($groups) < 1)) {
            throw new \InvalidArgumentException('invalid length for $groups when calling InlineObject1., number of items must be greater than or equal to 1.');
        }
    ...
    public function setServices($services)
    {
        ...
        if ((count($services) < 1)) {
            throw new \InvalidArgumentException('invalid length for $services when calling InlineObject1., number of items must be greater than or equal to 1.');
        }
    ...
    public function setTeamTitle($team_title)
    {
        ...
        if ((mb_strlen($team_title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $team_title when calling InlineObject1., must be bigger than or equal to 1.');
        }
    ...
    public function setTeam($team)
    {
        ...
        if ((count($team) < 1)) {
            throw new \InvalidArgumentException('invalid length for $team when calling InlineObject1., number of items must be greater than or equal to 1.');
        }
