...
/**
 * GetAllPersons200ResponseDataInnerMeta Class Doc Comment
 *
 * @category Class
 * @package  StevenBuehner\ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class GetAllPersons200ResponseDataInnerMeta implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getAllPersons_200_response_data_inner_meta';
    ...
    public function setModifiedDate($modified_date)
    {
        ...
        if (!is_null($modified_date) && (!preg_match("/^[0-9]{4}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}:[0-9]{2}Z$/", $modified_date))) {
            throw new \InvalidArgumentException("invalid value for $modified_date when calling GetAllPersons200ResponseDataInnerMeta., must conform to the pattern /^[0-9]{4}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}:[0-9]{2}Z$/.");
        }
