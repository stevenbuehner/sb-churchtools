...
/**
 * GetPersonMasterdata200ResponseDataCampusesInnerBanner Class Doc Comment
 *
 * @category Class
 * @package  StevenBuehner\ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class GetPersonMasterdata200ResponseDataCampusesInnerBanner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getPersonMasterdata_200_response_data_campuses_inner_banner';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['domain_type'] = $data['domain_type'] ?? 'file';
        $this->container['frontend_url'] = $data['frontend_url'] ?? null;
        $this->container['icon'] = $data['icon'] ?? 'file';
