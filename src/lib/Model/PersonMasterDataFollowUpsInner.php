<?php
/**
 * PersonMasterDataFollowUpsInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PersonMasterDataFollowUpsInner Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  StevenBuehner\ChurchTools
 ...
 */
class PersonMasterDataFollowUpsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PersonMasterData_followUps_inner';
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PersonMasterDataFollowUpsInner., must be bigger than or equal to 1.');
        }
    ...
    public function setNameTranslated($name_translated)
    {
        ...
        if ((mb_strlen($name_translated) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name_translated when calling PersonMasterDataFollowUpsInner., must be bigger than or equal to 1.');
        }
