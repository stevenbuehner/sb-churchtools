...
class GetResourceMasterdata200ResponseDataResourcesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('ical_location', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($ical_location)) {
            array_push($this->openAPINullablesSetToNull, 'ical_location');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('ical_location', $nullablesSetToNull);
            if ($index !== FALSE) {
