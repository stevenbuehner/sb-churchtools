...
/**
 * InlineResponse2002Services Class Doc Comment
 *
 * @category Class
 * @package  StevenBuehner\ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse2002Services implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_2_services';
    ...
    public function setRepetition($repetition)
    {
        ...
        if ((mb_strlen($repetition) < 1)) {
            throw new \InvalidArgumentException('invalid length for $repetition when calling InlineResponse2002Services., must be bigger than or equal to 1.');
        }
    ...
    public function setTime($time)
    {
        ...
        if ((mb_strlen($time) < 1)) {
            throw new \InvalidArgumentException('invalid length for $time when calling InlineResponse2002Services., must be bigger than or equal to 1.');
        }
