...
/**
 * PatchGroup200ResponseFollowUp Class Doc Comment
 *
 * @category Class
 * @package  StevenBuehner\ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class PatchGroup200ResponseFollowUp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'patchGroup_200_response_followUp';
    ...
    protected static array $openAPINullables = [
		...
		'target_group_member_status_id' => false,
		'target_object_id' => false,
    ...
    */
    ...
    public function setTargetGroupMemberStatusId($target_group_member_status_id)
    {
        if (is_null($target_group_member_status_id)) {
            throw new \InvalidArgumentException('non-nullable target_group_member_status_id cannot be null');
        }
    ...
    public function setTargetObjectId($target_object_id)
    {
        if (is_null($target_object_id)) {
            throw new \InvalidArgumentException('non-nullable target_object_id cannot be null');
        }
