...
/**
 * InlineResponse20044DataFollowUpIntervals Class Doc Comment
 *
 * @category Class
 * @package  StevenBuehner\ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse20044DataFollowUpIntervals implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_44_data_followUpIntervals';
    ...
    public function setInfo($info)
    {
        ...
        if ((mb_strlen($info) < 1)) {
            throw new \InvalidArgumentException('invalid length for $info when calling InlineResponse20044DataFollowUpIntervals., must be bigger than or equal to 1.');
        }
