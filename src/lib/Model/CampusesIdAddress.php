...
/**
 * CampusesIdAddress Class Doc Comment
 *
 * @category Class
 * @package  StevenBuehner\ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class CampusesIdAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_campuses__id__address';
    ...
    public function setMeetingAt($meeting_at)
    {
        ...
        if ((mb_strlen($meeting_at) < 1)) {
            throw new \InvalidArgumentException('invalid length for $meeting_at when calling CampusesIdAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setStreet($street)
    {
        ...
        if ((mb_strlen($street) < 1)) {
            throw new \InvalidArgumentException('invalid length for $street when calling CampusesIdAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setAddition($addition)
    {
        ...
        if ((mb_strlen($addition) < 1)) {
            throw new \InvalidArgumentException('invalid length for $addition when calling CampusesIdAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setDistrict($district)
    {
        ...
        if ((mb_strlen($district) < 1)) {
            throw new \InvalidArgumentException('invalid length for $district when calling CampusesIdAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setZip($zip)
    {
        ...
        if ((mb_strlen($zip) < 1)) {
            throw new \InvalidArgumentException('invalid length for $zip when calling CampusesIdAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setCity($city)
    {
        ...
        if ((mb_strlen($city) < 1)) {
            throw new \InvalidArgumentException('invalid length for $city when calling CampusesIdAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setLatitude($latitude)
    {
        ...
        if ((mb_strlen($latitude) < 1)) {
            throw new \InvalidArgumentException('invalid length for $latitude when calling CampusesIdAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setLongitude($longitude)
    {
        ...
        if ((mb_strlen($longitude) < 1)) {
            throw new \InvalidArgumentException('invalid length for $longitude when calling CampusesIdAddress., must be bigger than or equal to 1.');
        }
