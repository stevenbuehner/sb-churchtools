...
class CreateSyncMappingRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['last_synced_date'] === null && !$this->isNullableSetToNull('last_synced_date')) {
            $invalidProperties[] = "'last_synced_date' can't be null";
        }
        if ($this->container['source_entity_id'] === null && !$this->isNullableSetToNull('source_entity_id')) {
     ...
     * Sets domain_id
     *
     * @param string|null $domain_id Identifier of ChurchTools Entity
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $last_synced_date DateTime of Last Synchronisation in Zulu Format
     *
     * @return self
     */
     ...
     *
     * @param string|null $source_entity_id Identifier of Entity in Source System
     *
     * @return self
     */
