<?php
/**
 * InlineResponse200128DataAppointmentBaseCalendar
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * InlineResponse200128DataAppointmentBaseCalendar Class Doc Comment
 *
 * @category Class
 * @package  StevenBuehner\ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse200128DataAppointmentBaseCalendar implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_128_data_appointment_base_calendar';
    ...
    protected static $openAPITypes = [
        ...
        'meta' => '\StevenBuehner\ChurchTools\Model\InlineResponse200128DataAppointmentBaseCalendarMeta'
    ];
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineResponse200128DataAppointmentBaseCalendar., must be bigger than or equal to 1.');
        }
    ...
    public function setNameTranslated($name_translated)
    {
        ...
        if ((mb_strlen($name_translated) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name_translated when calling InlineResponse200128DataAppointmentBaseCalendar., must be bigger than or equal to 1.');
        }
    ...
    public function setColor($color)
    {
        ...
        if ((mb_strlen($color) < 1)) {
            throw new \InvalidArgumentException('invalid length for $color when calling InlineResponse200128DataAppointmentBaseCalendar., must be bigger than or equal to 1.');
        }
    ...
    public function setRandomUrl($random_url)
    {
        ...
        if ((mb_strlen($random_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $random_url when calling InlineResponse200128DataAppointmentBaseCalendar., must be bigger than or equal to 1.');
        }
     ...
     * Gets meta
     *
     * @return \StevenBuehner\ChurchTools\Model\InlineResponse200128DataAppointmentBaseCalendarMeta
     */
     ...
     * Sets meta
     *
     * @param \StevenBuehner\ChurchTools\Model\InlineResponse200128DataAppointmentBaseCalendarMeta $meta meta
     *
     * @return self
     */
