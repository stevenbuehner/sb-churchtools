...
class GroupHomepageApi
{
    ...
    /**
     * Operation getGroupForHomepage_0
     *
     * Public information of group
     *
     * @param  string $hash Group Homepage Hash (required)
     * @param  string $group_id Group ID (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getGroupForHomepage_0'] to see the possible values for this operation
     *
     ...
     */
    public function getGroupForHomepage_0($hash, $group_id, string $contentType = self::contentTypes['getGroupForHomepage_0'][0])
    {
        list($response) = $this->getGroupForHomepage_0WithHttpInfo($hash, $group_id, $contentType);
        return $response;
    }

    /**
     * Operation getGroupForHomepage_0WithHttpInfo
     *
     * Public information of group
     *
     * @param  string $hash Group Homepage Hash (required)
     ...
     */
    public function getGroupForHomepage_0WithHttpInfo($hash, $group_id, string $contentType = self::contentTypes['getGroupForHomepage_0'][0])
    {
        $request = $this->getGroupForHomepage_0Request($hash, $group_id, $contentType);
    ...
    /**
     * Operation getGroupForHomepage_0Async
     *
     * Public information of group
     *
     * @param  string $hash Group Homepage Hash (required)
     ...
     */
    public function getGroupForHomepage_0Async($hash, $group_id, string $contentType = self::contentTypes['getGroupForHomepage_0'][0])
    {
        return $this->getGroupForHomepage_0AsyncWithHttpInfo($hash, $group_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getGroupForHomepage_0AsyncWithHttpInfo
     *
     * Public information of group
     *
     * @param  string $hash Group Homepage Hash (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getGroupForHomepage_0AsyncWithHttpInfo($hash, $group_id, string $contentType = self::contentTypes['getGroupForHomepage_0'][0])
    {
        $returnType = '\StevenBuehner\ChurchTools\Model\PublicGroup1';
        $request = $this->getGroupForHomepage_0Request($hash, $group_id, $contentType);
    ...
    /**
     * Create request for operation 'getGroupForHomepage_0'
     *
     * @param  string $hash Group Homepage Hash (required)
     * @param  string $group_id Group ID (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getGroupForHomepage_0'] to see the possible values for this operation
     ...
     */
    public function getGroupForHomepage_0Request($hash, $group_id, string $contentType = self::contentTypes['getGroupForHomepage_0'][0])
    {

        // verify the required parameter 'hash' is set
        if ($hash === null || (is_array($hash) && count($hash) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $hash when calling getGroupForHomepage_0'
            );
        }
        ...
        if ($group_id === null || (is_array($group_id) && count($group_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $group_id when calling getGroupForHomepage_0'
            );
        }
    ...
    /**
     * Operation getGroupHomepage_0
     *
     * Get information about public groups with settings
     *
     * @param  string $hash Random hash for public groups (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getGroupHomepage_0'] to see the possible values for this operation
     *
     * @throws \StevenBuehner\ChurchTools\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \StevenBuehner\ChurchTools\Model\GetGroupHomepage200Response
     */
    public function getGroupHomepage_0($hash, string $contentType = self::contentTypes['getGroupHomepage_0'][0])
    {
        list($response) = $this->getGroupHomepage_0WithHttpInfo($hash, $contentType);
        return $response;
    }

    /**
     * Operation getGroupHomepage_0WithHttpInfo
     *
     * Get information about public groups with settings
     *
     * @param  string $hash Random hash for public groups (required)
     ...
     */
    public function getGroupHomepage_0WithHttpInfo($hash, string $contentType = self::contentTypes['getGroupHomepage_0'][0])
    {
        $request = $this->getGroupHomepage_0Request($hash, $contentType);
    ...
    /**
     * Operation getGroupHomepage_0Async
     *
     * Get information about public groups with settings
     *
     * @param  string $hash Random hash for public groups (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getGroupHomepage_0Async($hash, string $contentType = self::contentTypes['getGroupHomepage_0'][0])
    {
        return $this->getGroupHomepage_0AsyncWithHttpInfo($hash, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getGroupHomepage_0AsyncWithHttpInfo
     *
     * Get information about public groups with settings
     *
     * @param  string $hash Random hash for public groups (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getGroupHomepage_0AsyncWithHttpInfo($hash, string $contentType = self::contentTypes['getGroupHomepage_0'][0])
    {
        $returnType = '\StevenBuehner\ChurchTools\Model\GetGroupHomepage200Response';
        $request = $this->getGroupHomepage_0Request($hash, $contentType);
    ...
    /**
     * Create request for operation 'getGroupHomepage_0'
     *
     * @param  string $hash Random hash for public groups (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getGroupHomepage_0'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getGroupHomepage_0Request($hash, string $contentType = self::contentTypes['getGroupHomepage_0'][0])
    {

        // verify the required parameter 'hash' is set
        if ($hash === null || (is_array($hash) && count($hash) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $hash when calling getGroupHomepage_0'
            );
        }
    ...
    /**
     * Operation postPublicgroupsGroupIdMailToLeaders_0
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postPublicgroupsGroupIdMailToLeaders_0'] to see the possible values for this operation
     *
     * @throws \StevenBuehner\ChurchTools\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function postPublicgroupsGroupIdMailToLeaders_0($group_id, $post_publicgroups_group_id_mail_to_leaders_request = null, string $contentType = self::contentTypes['postPublicgroupsGroupIdMailToLeaders_0'][0])
    {
        $this->postPublicgroupsGroupIdMailToLeaders_0WithHttpInfo($group_id, $post_publicgroups_group_id_mail_to_leaders_request, $contentType);
    }

    /**
     * Operation postPublicgroupsGroupIdMailToLeaders_0WithHttpInfo
     *
     * Send a Mail to Public Group Leaders
     *
     * @param  string $group_id Group ID of the public group (required)
     ...
     */
    public function postPublicgroupsGroupIdMailToLeaders_0WithHttpInfo($group_id, $post_publicgroups_group_id_mail_to_leaders_request = null, string $contentType = self::contentTypes['postPublicgroupsGroupIdMailToLeaders_0'][0])
    {
        $request = $this->postPublicgroupsGroupIdMailToLeaders_0Request($group_id, $post_publicgroups_group_id_mail_to_leaders_request, $contentType);
    ...
    /**
     * Operation postPublicgroupsGroupIdMailToLeaders_0Async
     *
     * Send a Mail to Public Group Leaders
     *
     * @param  string $group_id Group ID of the public group (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postPublicgroupsGroupIdMailToLeaders_0Async($group_id, $post_publicgroups_group_id_mail_to_leaders_request = null, string $contentType = self::contentTypes['postPublicgroupsGroupIdMailToLeaders_0'][0])
    {
        return $this->postPublicgroupsGroupIdMailToLeaders_0AsyncWithHttpInfo($group_id, $post_publicgroups_group_id_mail_to_leaders_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation postPublicgroupsGroupIdMailToLeaders_0AsyncWithHttpInfo
     *
     * Send a Mail to Public Group Leaders
     *
     * @param  string $group_id Group ID of the public group (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postPublicgroupsGroupIdMailToLeaders_0AsyncWithHttpInfo($group_id, $post_publicgroups_group_id_mail_to_leaders_request = null, string $contentType = self::contentTypes['postPublicgroupsGroupIdMailToLeaders_0'][0])
    {
        $returnType = '';
        $request = $this->postPublicgroupsGroupIdMailToLeaders_0Request($group_id, $post_publicgroups_group_id_mail_to_leaders_request, $contentType);
    ...
    /**
     * Create request for operation 'postPublicgroupsGroupIdMailToLeaders_0'
     *
     * @param  string $group_id Group ID of the public group (required)
     * @param  \StevenBuehner\ChurchTools\Model\PostPublicgroupsGroupIdMailToLeadersRequest $post_publicgroups_group_id_mail_to_leaders_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postPublicgroupsGroupIdMailToLeaders_0'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postPublicgroupsGroupIdMailToLeaders_0Request($group_id, $post_publicgroups_group_id_mail_to_leaders_request = null, string $contentType = self::contentTypes['postPublicgroupsGroupIdMailToLeaders_0'][0])
    {

        // verify the required parameter 'group_id' is set
        if ($group_id === null || (is_array($group_id) && count($group_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $group_id when calling postPublicgroupsGroupIdMailToLeaders_0'
            );
        }
    ...
    /**
     * Operation postPublicgroupsGroupIdSignup_0
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postPublicgroupsGroupIdSignup_0'] to see the possible values for this operation
     *
     * @throws \StevenBuehner\ChurchTools\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \StevenBuehner\ChurchTools\Model\PostPublicgroupsGroupIdSignup200Response
     */
    public function postPublicgroupsGroupIdSignup_0($group_id, $post_publicgroups_group_id_signup_request = null, string $contentType = self::contentTypes['postPublicgroupsGroupIdSignup_0'][0])
    {
        list($response) = $this->postPublicgroupsGroupIdSignup_0WithHttpInfo($group_id, $post_publicgroups_group_id_signup_request, $contentType);
        return $response;
    }

    /**
     * Operation postPublicgroupsGroupIdSignup_0WithHttpInfo
     *
     * Send a Sign Up Form to Get Signed Up into a Public Group
     *
     * @param  string $group_id Group ID of the public group (required)
     ...
     */
    public function postPublicgroupsGroupIdSignup_0WithHttpInfo($group_id, $post_publicgroups_group_id_signup_request = null, string $contentType = self::contentTypes['postPublicgroupsGroupIdSignup_0'][0])
    {
        $request = $this->postPublicgroupsGroupIdSignup_0Request($group_id, $post_publicgroups_group_id_signup_request, $contentType);
    ...
    /**
     * Operation postPublicgroupsGroupIdSignup_0Async
     *
     * Send a Sign Up Form to Get Signed Up into a Public Group
     *
     * @param  string $group_id Group ID of the public group (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postPublicgroupsGroupIdSignup_0Async($group_id, $post_publicgroups_group_id_signup_request = null, string $contentType = self::contentTypes['postPublicgroupsGroupIdSignup_0'][0])
    {
        return $this->postPublicgroupsGroupIdSignup_0AsyncWithHttpInfo($group_id, $post_publicgroups_group_id_signup_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation postPublicgroupsGroupIdSignup_0AsyncWithHttpInfo
     *
     * Send a Sign Up Form to Get Signed Up into a Public Group
     *
     * @param  string $group_id Group ID of the public group (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postPublicgroupsGroupIdSignup_0AsyncWithHttpInfo($group_id, $post_publicgroups_group_id_signup_request = null, string $contentType = self::contentTypes['postPublicgroupsGroupIdSignup_0'][0])
    {
        $returnType = '\StevenBuehner\ChurchTools\Model\PostPublicgroupsGroupIdSignup200Response';
        $request = $this->postPublicgroupsGroupIdSignup_0Request($group_id, $post_publicgroups_group_id_signup_request, $contentType);
    ...
    /**
     * Create request for operation 'postPublicgroupsGroupIdSignup_0'
     *
     * @param  string $group_id Group ID of the public group (required)
     * @param  \StevenBuehner\ChurchTools\Model\PostPublicgroupsGroupIdSignupRequest $post_publicgroups_group_id_signup_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postPublicgroupsGroupIdSignup_0'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postPublicgroupsGroupIdSignup_0Request($group_id, $post_publicgroups_group_id_signup_request = null, string $contentType = self::contentTypes['postPublicgroupsGroupIdSignup_0'][0])
    {

        // verify the required parameter 'group_id' is set
        if ($group_id === null || (is_array($group_id) && count($group_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $group_id when calling postPublicgroupsGroupIdSignup_0'
            );
        }
