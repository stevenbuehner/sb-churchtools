...
class AbsenceApi
{
    ...
    {
        list($response) = $this->getGroupsAbsencesWithHttpInfo($group_id, $from_date, $to_date);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getGroupsAbsencesAsync($group_id, $from_date = null, $to_date = null)
    {
        return $this->getGroupsAbsencesAsyncWithHttpInfo($group_id, $from_date, $to_date)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getGroupsAbsencesRequest($group_id, $from_date = null, $to_date = null)
    {
     ...
     * @return \StevenBuehner\ChurchTools\Model\PostPersonsAbsences201Response
     */
    public function postPersonsAbsences($person_id, $post_persons_absences_request = null)
    {
        list($response) = $this->postPersonsAbsencesWithHttpInfo($person_id, $post_persons_absences_request);
        return $response;
    }
     ...
     * @return array of \StevenBuehner\ChurchTools\Model\PostPersonsAbsences201Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function postPersonsAbsencesWithHttpInfo($person_id, $post_persons_absences_request = null)
    {
        $request = $this->postPersonsAbsencesRequest($person_id, $post_persons_absences_request);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postPersonsAbsencesAsync($person_id, $post_persons_absences_request = null)
    {
        return $this->postPersonsAbsencesAsyncWithHttpInfo($person_id, $post_persons_absences_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postPersonsAbsencesAsyncWithHttpInfo($person_id, $post_persons_absences_request = null)
    {
        $returnType = '\StevenBuehner\ChurchTools\Model\PostPersonsAbsences201Response';
        $request = $this->postPersonsAbsencesRequest($person_id, $post_persons_absences_request);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postPersonsAbsencesRequest($person_id, $post_persons_absences_request = null)
    {
        // verify the required parameter 'person_id' is set
        if ($person_id === null || (is_array($person_id) && count($person_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \StevenBuehner\ChurchTools\Model\PostPersonsAbsences201Response
     */
    public function putPersonsAbsence($person_id, $id, $put_persons_absence_request = null)
    {
        list($response) = $this->putPersonsAbsenceWithHttpInfo($person_id, $id, $put_persons_absence_request);
        return $response;
    }
     ...
     * @return array of \StevenBuehner\ChurchTools\Model\PostPersonsAbsences201Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function putPersonsAbsenceWithHttpInfo($person_id, $id, $put_persons_absence_request = null)
    {
        $request = $this->putPersonsAbsenceRequest($person_id, $id, $put_persons_absence_request);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putPersonsAbsenceAsync($person_id, $id, $put_persons_absence_request = null)
    {
        return $this->putPersonsAbsenceAsyncWithHttpInfo($person_id, $id, $put_persons_absence_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putPersonsAbsenceAsyncWithHttpInfo($person_id, $id, $put_persons_absence_request = null)
    {
        $returnType = '\StevenBuehner\ChurchTools\Model\PostPersonsAbsences201Response';
        $request = $this->putPersonsAbsenceRequest($person_id, $id, $put_persons_absence_request);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function putPersonsAbsenceRequest($person_id, $id, $put_persons_absence_request = null)
    {
        // verify the required parameter 'person_id' is set
        if ($person_id === null || (is_array($person_id) && count($person_id) === 0)) {
            throw new \InvalidArgumentException(
