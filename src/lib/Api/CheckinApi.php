...
class CheckinApi
{
     ...
     *
     * @param  \StevenBuehner\ChurchTools\Model\PostCheckinPersonsRequest|null $post_checkin_persons_request  (optional)
     ...
     *
     * @param  \StevenBuehner\ChurchTools\Model\PutCheckinPersonsRequest|null $put_checkin_persons_request  (optional)
