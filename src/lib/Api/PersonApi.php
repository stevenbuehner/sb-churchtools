...
/**
     ...
     */
    public function getPersonsDuplicates($tolerance = 30, $relation_name_for_duplicate = null, string $contentType = self::contentTypes['getPersonsDuplicates'][0])
    {
        list($response) = $this->getPersonsDuplicatesWithHttpInfo($tolerance, $relation_name_for_duplicate, $contentType);
        return $response;
    }
     ...
     */
    public function getPersonsDuplicatesWithHttpInfo($tolerance = 30, $relation_name_for_duplicate = null, string $contentType = self::contentTypes['getPersonsDuplicates'][0])
    {
        $request = $this->getPersonsDuplicatesRequest($tolerance, $relation_name_for_duplicate, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPersonsDuplicatesAsync($tolerance = 30, $relation_name_for_duplicate = null, string $contentType = self::contentTypes['getPersonsDuplicates'][0])
    {
        return $this->getPersonsDuplicatesAsyncWithHttpInfo($tolerance, $relation_name_for_duplicate, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPersonsDuplicatesAsyncWithHttpInfo($tolerance = 30, $relation_name_for_duplicate = null, string $contentType = self::contentTypes['getPersonsDuplicates'][0])
    {
        $returnType = '\StevenBuehner\ChurchTools\Model\GetPersonsDuplicates200Response';
        $request = $this->getPersonsDuplicatesRequest($tolerance, $relation_name_for_duplicate, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getPersonsDuplicatesRequest($tolerance = 30, $relation_name_for_duplicate = null, string $contentType = self::contentTypes['getPersonsDuplicates'][0])
    {
