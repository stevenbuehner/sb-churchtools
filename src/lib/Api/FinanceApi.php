...
class FinanceApi
{
     ...
     *
     * @param  \StevenBuehner\ChurchTools\Model\BatchTransactionRequest|null $batch_transaction_request Batch information consists of changeset and filters. (optional)
    ...
    public function batchTransactionRequest($batch_transaction_request = null, string $contentType = self::contentTypes['batchTransaction'][0])
    {
        ...
        if (isset($batch_transaction_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($batch_transaction_request));
            } else {
     ...
     *
     * @param  int $id ID of Entity (required)
     * @param  \StevenBuehner\ChurchTools\Model\CancelTransactionRequest $cancel_transaction_request Storno data (required)
     ...
     */
    public function cancelTransaction($id, $cancel_transaction_request, string $contentType = self::contentTypes['cancelTransaction'][0])
    {
        list($response) = $this->cancelTransactionWithHttpInfo($id, $cancel_transaction_request, $contentType);
        return $response;
    }
     ...
     */
    public function cancelTransactionWithHttpInfo($id, $cancel_transaction_request, string $contentType = self::contentTypes['cancelTransaction'][0])
    {
        $request = $this->cancelTransactionRequest($id, $cancel_transaction_request, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cancelTransactionAsync($id, $cancel_transaction_request, string $contentType = self::contentTypes['cancelTransaction'][0])
    {
        return $this->cancelTransactionAsyncWithHttpInfo($id, $cancel_transaction_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cancelTransactionAsyncWithHttpInfo($id, $cancel_transaction_request, string $contentType = self::contentTypes['cancelTransaction'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function cancelTransactionRequest($id, $cancel_transaction_request, string $contentType = self::contentTypes['cancelTransaction'][0])
    {
        ...
        // verify the required parameter 'cancel_transaction_request' is set
        if ($cancel_transaction_request === null || (is_array($cancel_transaction_request) && count($cancel_transaction_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $cancel_transaction_request when calling cancelTransaction'
            );
        }


        $resourcePath = '/finance/transactions/{id}/storno';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($cancel_transaction_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($cancel_transaction_request));
            } else {
                $httpBody = $cancel_transaction_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
    ...
    public function createCashDiscountRequest($create_cash_discount_request, string $contentType = self::contentTypes['createCashDiscount'][0])
    {
        ...
        if (isset($create_cash_discount_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($create_cash_discount_request));
            } else {
    ...
    public function createCostCenterRequest($create_cost_center_request, string $contentType = self::contentTypes['createCostCenter'][0])
    {
        ...
        if (isset($create_cost_center_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($create_cost_center_request));
            } else {
    ...
    public function createNewAccountRequest($create_new_account_request, string $contentType = self::contentTypes['createNewAccount'][0])
    {
        ...
        if (isset($create_new_account_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($create_new_account_request));
            } else {
    ...
    public function createNewAccountClassRequest($create_new_account_class_request, string $contentType = self::contentTypes['createNewAccountClass'][0])
    {
        ...
        if (isset($create_new_account_class_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($create_new_account_class_request));
            } else {
    ...
    public function createNewAccountGroupRequest($create_new_account_group_request, string $contentType = self::contentTypes['createNewAccountGroup'][0])
    {
        ...
        if (isset($create_new_account_group_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($create_new_account_group_request));
            } else {
    ...
    public function createNewAccountTypeRequest($create_new_account_type_request, string $contentType = self::contentTypes['createNewAccountType'][0])
    {
        ...
        if (isset($create_new_account_type_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($create_new_account_type_request));
            } else {
    ...
    public function createNewAccountingPeriodRequest($create_new_accounting_period_request, string $contentType = self::contentTypes['createNewAccountingPeriod'][0])
    {
        ...
        if (isset($create_new_accounting_period_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($create_new_accounting_period_request));
            } else {
    ...
    public function createNewClientRequest($create_new_client_request, string $contentType = self::contentTypes['createNewClient'][0])
    {
        ...
        if (isset($create_new_client_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($create_new_client_request));
            } else {
    ...
    public function createNewTransactionRequest($create_new_transaction_request, string $contentType = self::contentTypes['createNewTransaction'][0])
    {
        ...
        if (isset($create_new_transaction_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($create_new_transaction_request));
            } else {
    ...
    public function createNewTransactionPurposeRequest($create_new_transaction_purpose_request, string $contentType = self::contentTypes['createNewTransactionPurpose'][0])
    {
        ...
        if (isset($create_new_transaction_purpose_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($create_new_transaction_purpose_request));
            } else {
    ...
    public function createTaxRateRequest($create_tax_rate_request, string $contentType = self::contentTypes['createTaxRate'][0])
    {
        ...
        if (isset($create_tax_rate_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($create_tax_rate_request));
            } else {
    ...
    public function createTaxTypeRequest($create_tax_type_request, string $contentType = self::contentTypes['createTaxType'][0])
    {
        ...
        if (isset($create_tax_type_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($create_tax_type_request));
            } else {
     ...
     *
     * @param  int $accounting_period_id ID of accounting period to get master data for (required)
     * @param  bool|null $calculate_balance Calculate balance for accounts (optional)
     ...
     *
     * @param  int $accounting_period_id ID of accounting period to get master data for (required)
     * @param  string|null $mode mode: seperate letter and attachtment in two files (optional, default to 'twofiles')
     * @param  string|null $cleardoublepage add empty pages to clear double page for  &#39;all&#39;, &#39;letter&#39;, &#39;attachment&#39; (optional, default to 'none')
     ...
     *
     * @param  int $accounting_period_id ID of accounting period to get master data for (required)
     * @param  string|null $order_by Default is &#x60;name&#x60;. (optional)
     * @param  string|null $order_direction Way of direction: ascending or descending (optional)
     ...
     * @param  string|null $query String to be included in donator&#39;s first name or last name (optional)
     ...
     * @return \StevenBuehner\ChurchTools\Model\GetAllDonators200Response|string
     */
    public function getAllDonators($accounting_period_id, $order_by = null, $order_direction = null, $page = 1, $limit = 10, $query = null, string $contentType = self::contentTypes['getAllDonators'][0])
    {
        list($response) = $this->getAllDonatorsWithHttpInfo($accounting_period_id, $order_by, $order_direction, $page, $limit, $query, $contentType);
        return $response;
    }
     ...
     * @return array of \StevenBuehner\ChurchTools\Model\GetAllDonators200Response|string, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAllDonatorsWithHttpInfo($accounting_period_id, $order_by = null, $order_direction = null, $page = 1, $limit = 10, $query = null, string $contentType = self::contentTypes['getAllDonators'][0])
    {
        $request = $this->getAllDonatorsRequest($accounting_period_id, $order_by, $order_direction, $page, $limit, $query, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllDonatorsAsync($accounting_period_id, $order_by = null, $order_direction = null, $page = 1, $limit = 10, $query = null, string $contentType = self::contentTypes['getAllDonators'][0])
    {
        return $this->getAllDonatorsAsyncWithHttpInfo($accounting_period_id, $order_by, $order_direction, $page, $limit, $query, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllDonatorsAsyncWithHttpInfo($accounting_period_id, $order_by = null, $order_direction = null, $page = 1, $limit = 10, $query = null, string $contentType = self::contentTypes['getAllDonators'][0])
    {
        $returnType = '\StevenBuehner\ChurchTools\Model\GetAllDonators200Response';
        $request = $this->getAllDonatorsRequest($accounting_period_id, $order_by, $order_direction, $page, $limit, $query, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAllDonatorsRequest($accounting_period_id, $order_by = null, $order_direction = null, $page = 1, $limit = 10, $query = null, string $contentType = self::contentTypes['getAllDonators'][0])
    {
        ...
        if ($query !== null && strlen($query) < 2) {
            throw new \InvalidArgumentException('invalid length for "$query" when calling FinanceApi.getAllDonators, must be bigger than or equal to 2.');
        }
     ...
     *
     * @param  int $accounting_period_id ID of accounting period to get master data for (required)
     * @param  int|null $created_pid Filter by person ID. Get all transactions the person has created. But only show those the user can see. (optional)
     * @param  int[]|null $cost_center_ids Filter by cost centers. (optional)
     * @param  int[]|null $donator_ids Filter by donator or donator spouse. Provide an array of person ids. (optional)
     * @param  int[]|null $account_ids Filter by account/contra account. All transactions match, where either account or contra account is in the list. (optional)
     * @param  bool|null $is_donation Filter by donations. &#x60;true&#x60; &#x3D; Only donations, &#x60;false&#x60; &#x3D; Other than donation. (optional)
     * @param  bool|null $is_income Filter transactions by income or outcome transactions. An account group has a flag &#x60;cash asset account&#x60; to indicate accounts for income/outcome. (optional)
     * @param  \DateTime|null $start_date Show transactions after this date. (optional)
     * @param  \DateTime|null $end_date Show transactions before this date. (optional)
     * @param  bool|null $is_immutable Filter transactions, whether transaction is immutable. (optional)
     * @param  string|null $order_by Default is &#x60;date&#x60;. Order transactions either by document date, amount, or modified date. For &#x60;date&#x60; and &#x60;amount&#x60; a second sorting happens by modified. The order direction for modified date is the same as for date and amount. (optional)
     * @param  string|null $order_direction Way of direction: ascending or descending (optional)
     * @param  int|null $page Page number to show page in pagenation. If empty, start at first page. (optional, default to 1)
     * @param  int|null $limit Number of results per page. (optional, default to 10)
     ...
     * @param  int|null $donator_spouse_id ID of the donator spouse to create the donation receipt for (optional)
     ...
     * Your GET endpoint
     *
     * @param  int|null $accounting_period_id The accounting period to get the result set from (optional)
     ...
     *
     * @param  \StevenBuehner\ChurchTools\Model\PostFinanceCostcentersBulkcreateRequest|null $post_finance_costcenters_bulkcreate_request post_finance_costcenters_bulkcreate_request (optional)
     ...
     * Import many cost centers
     *
     * @param  \StevenBuehner\ChurchTools\Model\PostFinanceCostcentersBulkcreateRequest|null $post_finance_costcenters_bulkcreate_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postFinanceCostcentersBulkcreate'] to see the possible values for this operation
     *
     * @throws \StevenBuehner\ChurchTools\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
    ...
    public function postFinanceCostcentersBulkcreateRequest($post_finance_costcenters_bulkcreate_request = null, string $contentType = self::contentTypes['postFinanceCostcentersBulkcreate'][0])
    {
        ...
        if (isset($post_finance_costcenters_bulkcreate_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($post_finance_costcenters_bulkcreate_request));
            } else {
     ...
     * @param  \StevenBuehner\ChurchTools\Model\PostFinanceReportsRequest|null $post_finance_reports_request  (optional)
     ...
     * @throws \StevenBuehner\ChurchTools\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \StevenBuehner\ChurchTools\Model\PostFinanceTurnoverReport200Response
     */
     ...
     * @throws \StevenBuehner\ChurchTools\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \StevenBuehner\ChurchTools\Model\PostFinanceTurnoverReport200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function postFinanceReportsWithHttpInfo($report_type, $post_finance_reports_request = null, string $contentType = self::contentTypes['postFinanceReports'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\StevenBuehner\ChurchTools\Model\PostFinanceTurnoverReport200Response',
                        $request,
                        $response,
                    );
            }
    ...
    {
        $returnType = '\StevenBuehner\ChurchTools\Model\PostFinanceTurnoverReport200Response';
        $request = $this->postFinanceReportsRequest($report_type, $post_finance_reports_request, $contentType);
    ...
    public function postFinanceReportsRequest($report_type, $post_finance_reports_request = null, string $contentType = self::contentTypes['postFinanceReports'][0])
    {
        ...
        if (isset($post_finance_reports_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($post_finance_reports_request));
            } else {
    ...
    /**
     * Operation postFinanceTurnoverReport
     *
     * Issue new Turnover Report
     *
     * @param  \StevenBuehner\ChurchTools\Model\PostFinanceTurnoverReportRequest|null $post_finance_turnover_report_request  (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postFinanceTurnoverReport'] to see the possible values for this operation
     *
     * @throws \StevenBuehner\ChurchTools\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \StevenBuehner\ChurchTools\Model\PostFinanceTurnoverReport200Response
     */
    public function postFinanceTurnoverReport($post_finance_turnover_report_request = null, string $contentType = self::contentTypes['postFinanceTurnoverReport'][0])
    {
        list($response) = $this->postFinanceTurnoverReportWithHttpInfo($post_finance_turnover_report_request, $contentType);
        return $response;
    }

    /**
     * Operation postFinanceTurnoverReportWithHttpInfo
     *
     * Issue new Turnover Report
     *
     * @param  \StevenBuehner\ChurchTools\Model\PostFinanceTurnoverReportRequest|null $post_finance_turnover_report_request  (optional)
     ...
     * @return array of \StevenBuehner\ChurchTools\Model\PostFinanceTurnoverReport200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function postFinanceTurnoverReportWithHttpInfo($post_finance_turnover_report_request = null, string $contentType = self::contentTypes['postFinanceTurnoverReport'][0])
    {
        $request = $this->postFinanceTurnoverReportRequest($post_finance_turnover_report_request, $contentType);
    ...
    /**
     * Operation postFinanceTurnoverReportAsync
     *
     * Issue new Turnover Report
     *
     * @param  \StevenBuehner\ChurchTools\Model\PostFinanceTurnoverReportRequest|null $post_finance_turnover_report_request  (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postFinanceTurnoverReportAsync($post_finance_turnover_report_request = null, string $contentType = self::contentTypes['postFinanceTurnoverReport'][0])
    {
        return $this->postFinanceTurnoverReportAsyncWithHttpInfo($post_finance_turnover_report_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation postFinanceTurnoverReportAsyncWithHttpInfo
     *
     * Issue new Turnover Report
     *
     * @param  \StevenBuehner\ChurchTools\Model\PostFinanceTurnoverReportRequest|null $post_finance_turnover_report_request  (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postFinanceTurnoverReportAsyncWithHttpInfo($post_finance_turnover_report_request = null, string $contentType = self::contentTypes['postFinanceTurnoverReport'][0])
    {
        $returnType = '\StevenBuehner\ChurchTools\Model\PostFinanceTurnoverReport200Response';
        $request = $this->postFinanceTurnoverReportRequest($post_finance_turnover_report_request, $contentType);
    ...
    /**
     * Create request for operation 'postFinanceTurnoverReport'
     *
     * @param  \StevenBuehner\ChurchTools\Model\PostFinanceTurnoverReportRequest|null $post_finance_turnover_report_request  (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postFinanceTurnoverReport'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postFinanceTurnoverReportRequest($post_finance_turnover_report_request = null, string $contentType = self::contentTypes['postFinanceTurnoverReport'][0])
    {



        $resourcePath = '/finance/reports/turnover';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($post_finance_turnover_report_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($post_finance_turnover_report_request));
            } else {
                $httpBody = $post_finance_turnover_report_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
    ...
    public function updateAccountingPeriodRequest($id, $update_accounting_period_request, string $contentType = self::contentTypes['updateAccountingPeriod'][0])
    {
        ...
        if (isset($update_accounting_period_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($update_accounting_period_request));
            } else {
    ...
    public function updateCostCenterRequest($id, $update_cost_center_request, string $contentType = self::contentTypes['updateCostCenter'][0])
    {
        ...
        if (isset($update_cost_center_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($update_cost_center_request));
            } else {
