...
class MasterDataApi
{
    ...
    /**
     * Operation getResourceMasterdata_0
     *
     * Your GET endpoint
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getResourceMasterdata_0'] to see the possible values for this operation
     *
     * @throws \StevenBuehner\ChurchTools\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \StevenBuehner\ChurchTools\Model\GetResourceMasterdata200Response
     */
    public function getResourceMasterdata_0(string $contentType = self::contentTypes['getResourceMasterdata_0'][0])
    {
        list($response) = $this->getResourceMasterdata_0WithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation getResourceMasterdata_0WithHttpInfo
     *
     * Your GET endpoint
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getResourceMasterdata_0'] to see the possible values for this operation
     ...
     */
    public function getResourceMasterdata_0WithHttpInfo(string $contentType = self::contentTypes['getResourceMasterdata_0'][0])
    {
        $request = $this->getResourceMasterdata_0Request($contentType);
    ...
    /**
     * Operation getResourceMasterdata_0Async
     *
     * Your GET endpoint
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getResourceMasterdata_0'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getResourceMasterdata_0Async(string $contentType = self::contentTypes['getResourceMasterdata_0'][0])
    {
        return $this->getResourceMasterdata_0AsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getResourceMasterdata_0AsyncWithHttpInfo
     *
     * Your GET endpoint
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getResourceMasterdata_0'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getResourceMasterdata_0AsyncWithHttpInfo(string $contentType = self::contentTypes['getResourceMasterdata_0'][0])
    {
        $returnType = '\StevenBuehner\ChurchTools\Model\GetResourceMasterdata200Response';
        $request = $this->getResourceMasterdata_0Request($contentType);
    ...
    /**
     * Create request for operation 'getResourceMasterdata_0'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getResourceMasterdata_0'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getResourceMasterdata_0Request(string $contentType = self::contentTypes['getResourceMasterdata_0'][0])
    {
