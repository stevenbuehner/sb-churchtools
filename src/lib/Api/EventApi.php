...
/**
    ...
    /**
     * Operation personsPersonIdEventsEventIdServicesServiceIdExchangerequestsGet
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['personsPersonIdEventsEventIdServicesServiceIdExchangerequestsGet'] to see the possible values for this operation
     *
     * @throws \StevenBuehner\ChurchTools\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \StevenBuehner\ChurchTools\Model\1[]
     */
    public function personsPersonIdEventsEventIdServicesServiceIdExchangerequestsGet($person_id, $event_id, $service_id, $incoming = null, string $contentType = self::contentTypes['personsPersonIdEventsEventIdServicesServiceIdExchangerequestsGet'][0])
    {
        list($response) = $this->personsPersonIdEventsEventIdServicesServiceIdExchangerequestsGetWithHttpInfo($person_id, $event_id, $service_id, $incoming, $contentType);
        return $response;
    }

    /**
     * Operation personsPersonIdEventsEventIdServicesServiceIdExchangerequestsGetWithHttpInfo
     *
     * Get all service exchange requests of a user for a service
     *
     * @param  int $person_id ID of person (required)
     ...
     */
    public function personsPersonIdEventsEventIdServicesServiceIdExchangerequestsGetWithHttpInfo($person_id, $event_id, $service_id, $incoming = null, string $contentType = self::contentTypes['personsPersonIdEventsEventIdServicesServiceIdExchangerequestsGet'][0])
    {
        $request = $this->personsPersonIdEventsEventIdServicesServiceIdExchangerequestsGetRequest($person_id, $event_id, $service_id, $incoming, $contentType);
    ...
    /**
     * Operation personsPersonIdEventsEventIdServicesServiceIdExchangerequestsGetAsync
     *
     * Get all service exchange requests of a user for a service
     *
     * @param  int $person_id ID of person (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function personsPersonIdEventsEventIdServicesServiceIdExchangerequestsGetAsync($person_id, $event_id, $service_id, $incoming = null, string $contentType = self::contentTypes['personsPersonIdEventsEventIdServicesServiceIdExchangerequestsGet'][0])
    {
        return $this->personsPersonIdEventsEventIdServicesServiceIdExchangerequestsGetAsyncWithHttpInfo($person_id, $event_id, $service_id, $incoming, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation personsPersonIdEventsEventIdServicesServiceIdExchangerequestsGetAsyncWithHttpInfo
     *
     * Get all service exchange requests of a user for a service
     *
     * @param  int $person_id ID of person (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function personsPersonIdEventsEventIdServicesServiceIdExchangerequestsGetAsyncWithHttpInfo($person_id, $event_id, $service_id, $incoming = null, string $contentType = self::contentTypes['personsPersonIdEventsEventIdServicesServiceIdExchangerequestsGet'][0])
    {
        $returnType = '\StevenBuehner\ChurchTools\Model\1[]';
        $request = $this->personsPersonIdEventsEventIdServicesServiceIdExchangerequestsGetRequest($person_id, $event_id, $service_id, $incoming, $contentType);
    ...
    /**
     * Create request for operation 'personsPersonIdEventsEventIdServicesServiceIdExchangerequestsGet'
     *
     * @param  int $person_id ID of person (required)
     * @param  int $event_id ID of Event (required)
     * @param  string $service_id (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function personsPersonIdEventsEventIdServicesServiceIdExchangerequestsGetRequest($person_id, $event_id, $service_id, $incoming = null, string $contentType = self::contentTypes['personsPersonIdEventsEventIdServicesServiceIdExchangerequestsGet'][0])
    {

        // verify the required parameter 'person_id' is set
        if ($person_id === null || (is_array($person_id) && count($person_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $person_id when calling personsPersonIdEventsEventIdServicesServiceIdExchangerequestsGet'
            );
        }
        ...
        if ($event_id === null || (is_array($event_id) && count($event_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $event_id when calling personsPersonIdEventsEventIdServicesServiceIdExchangerequestsGet'
            );
        }
        ...
        if ($service_id === null || (is_array($service_id) && count($service_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $service_id when calling personsPersonIdEventsEventIdServicesServiceIdExchangerequestsGet'
            );
        }
     ...
     * @return void
     */
    public function postPersonIdEventsEventIdServicesServiceIdExchangerequests($person_id, $event_id, $service_id, $incoming = null, $_1 = null, string $contentType = self::contentTypes['postPersonIdEventsEventIdServicesServiceIdExchangerequests'][0])
    {
        $this->postPersonIdEventsEventIdServicesServiceIdExchangerequestsWithHttpInfo($person_id, $event_id, $service_id, $incoming, $_1, $contentType);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function postPersonIdEventsEventIdServicesServiceIdExchangerequestsWithHttpInfo($person_id, $event_id, $service_id, $incoming = null, $_1 = null, string $contentType = self::contentTypes['postPersonIdEventsEventIdServicesServiceIdExchangerequests'][0])
    {
        $request = $this->postPersonIdEventsEventIdServicesServiceIdExchangerequestsRequest($person_id, $event_id, $service_id, $incoming, $_1, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postPersonIdEventsEventIdServicesServiceIdExchangerequestsAsync($person_id, $event_id, $service_id, $incoming = null, $_1 = null, string $contentType = self::contentTypes['postPersonIdEventsEventIdServicesServiceIdExchangerequests'][0])
    {
        return $this->postPersonIdEventsEventIdServicesServiceIdExchangerequestsAsyncWithHttpInfo($person_id, $event_id, $service_id, $incoming, $_1, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postPersonIdEventsEventIdServicesServiceIdExchangerequestsAsyncWithHttpInfo($person_id, $event_id, $service_id, $incoming = null, $_1 = null, string $contentType = self::contentTypes['postPersonIdEventsEventIdServicesServiceIdExchangerequests'][0])
    {
        $returnType = '';
        $request = $this->postPersonIdEventsEventIdServicesServiceIdExchangerequestsRequest($person_id, $event_id, $service_id, $incoming, $_1, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postPersonIdEventsEventIdServicesServiceIdExchangerequestsRequest($person_id, $event_id, $service_id, $incoming = null, $_1 = null, string $contentType = self::contentTypes['postPersonIdEventsEventIdServicesServiceIdExchangerequests'][0])
    {
        ...
        if (isset($_1)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($_1));
            } else {
                $httpBody = $_1;
            }
        } elseif (count($formParams) > 0) {
