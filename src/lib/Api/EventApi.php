...
class EventApi
{
     ...
     * @param  \StevenBuehner\ChurchTools\Model\AgendaExportRequest|null $agenda_export_request agenda_export_request (optional)
     ...
     * @param  \StevenBuehner\ChurchTools\Model\AgendaExportRequest|null $agenda_export_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['agendaExport'] to see the possible values for this operation
     *
     * @throws \StevenBuehner\ChurchTools\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  \StevenBuehner\ChurchTools\Model\DeletePersonIdEventsEventIdServicesServiceIdExchangerequestsCopyRequest|null $delete_person_id_events_event_id_services_service_id_exchangerequests_copy_request delete_person_id_events_event_id_services_service_id_exchangerequests_copy_request (optional)
     ...
     * @param  \StevenBuehner\ChurchTools\Model\DeletePersonIdEventsEventIdServicesServiceIdExchangerequestsCopyRequest|null $delete_person_id_events_event_id_services_service_id_exchangerequests_copy_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['deletePersonIdEventsEventIdServicesServiceIdExchangerequestsCopy'] to see the possible values for this operation
     *
     * @throws \StevenBuehner\ChurchTools\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * Get all events
     *
     * @param  \DateTime|null $from Start date from when events are returned. Default value: today (optional)
     * @param  \DateTime|null $to End date until when events are returned. Default value: two month from now (optional)
     ...
     * @throws \StevenBuehner\ChurchTools\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \StevenBuehner\ChurchTools\Model\Model200Response
     */
     ...
     * @throws \StevenBuehner\ChurchTools\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \StevenBuehner\ChurchTools\Model\Model200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function personsPersonIdEventsEventIdServicesServiceIdExchangerequestsCandidatesGetWithHttpInfo($person_id, $event_id, $service_id, string $contentType = self::contentTypes['personsPersonIdEventsEventIdServicesServiceIdExchangerequestsCandidatesGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\StevenBuehner\ChurchTools\Model\Model200Response',
                        $request,
                        $response,
                    );
            }
    ...
    {
        $returnType = '\StevenBuehner\ChurchTools\Model\Model200Response';
        $request = $this->personsPersonIdEventsEventIdServicesServiceIdExchangerequestsCandidatesGetRequest($person_id, $event_id, $service_id, $contentType);
     ...
     * @param  string $service_id service_id (required)
     * @param  bool|null $incoming If set to true, service exchange requests from other users for the user are returned. Otherwise (default) requests from this user for other users are returned. (optional)
     * @param  \StevenBuehner\ChurchTools\Model\PersonEventsServices200ResponseInner|null $person_events_services200_response_inner person_events_services200_response_inner (optional)
     ...
     * @param  string $service_id (required)
     * @param  bool|null $incoming If set to true, service exchange requests from other users for the user are returned. Otherwise (default) requests from this user for other users are returned. (optional)
     * @param  \StevenBuehner\ChurchTools\Model\PersonEventsServices200ResponseInner|null $person_events_services200_response_inner (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postPersonIdEventsEventIdServicesServiceIdExchangerequests'] to see the possible values for this operation
     *
     * @throws \StevenBuehner\ChurchTools\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
