...
class CalendarApi
{
     ...
     *
     * @param  int $calendar_id ID of Calendar (required)
     * @param  \StevenBuehner\ChurchTools\Model\PostCalendarsCalendarIdAppointmentsRequest|null $post_calendars_calendar_id_appointments_request post_calendars_calendar_id_appointments_request (optional)
     ...
     *
     * @param  int $calendar_id ID of Calendar (required)
     * @param  \StevenBuehner\ChurchTools\Model\PostCalendarsCalendarIdAppointmentsRequest|null $post_calendars_calendar_id_appointments_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postCalendarsCalendarIdAppointments'] to see the possible values for this operation
     *
     * @throws \StevenBuehner\ChurchTools\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
