...
class HiddenApi
{
     ...
     * @param  string|null $accounting_period_id accounting_period_id (optional)
     * @param  string|null $target select special Columns for particular target (optional)
     ...
     * @param  string|null $accounting_period_id (optional)
     * @param  string|null $target select special Columns for particular target (optional)
     ...
     * Save NPS score
     *
     * @param  \StevenBuehner\ChurchTools\Model\PostNpsRequest|null $post_nps_request A valid score between 1 and 10 is stored to the database. Any other number than that is intepreted as decline. Thas means, no score is saved but the user is marked as he has voted. (optional)
     ...
     * 
     *
     * @param  \StevenBuehner\ChurchTools\Model\PostOauthclientsRequest|null $post_oauthclients_request  (optional)
     ...
     *
     * @param  string $identifier identifier (required)
     * @param  \StevenBuehner\ChurchTools\Model\PostOauthclientsRequest|null $post_oauthclients_request post_oauthclients_request (optional)
     ...
     * 
     *
     * @param  \StevenBuehner\ChurchTools\Model\UpdateCampusRequest|null $update_campus_request update_campus_request (optional)
     ...
     * 
     *
     * @param  \StevenBuehner\ChurchTools\Model\UpdateCampusRequest|null $update_campus_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['putProfilesChurch'] to see the possible values for this operation
     *
     * @throws \StevenBuehner\ChurchTools\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
