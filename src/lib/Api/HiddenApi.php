...
/**
     ...
     * @return void
     */
    public function patchGroup($group_id, string $contentType = self::contentTypes['patchGroup'][0])
    {
        $this->patchGroupWithHttpInfo($group_id, $contentType);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function patchGroupWithHttpInfo($group_id, string $contentType = self::contentTypes['patchGroup'][0])
    {
        $request = $this->patchGroupRequest($group_id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchGroupAsync($group_id, string $contentType = self::contentTypes['patchGroup'][0])
    {
        return $this->patchGroupAsyncWithHttpInfo($group_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchGroupAsyncWithHttpInfo($group_id, string $contentType = self::contentTypes['patchGroup'][0])
    {
        $returnType = '';
        $request = $this->patchGroupRequest($group_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchGroupRequest($group_id, string $contentType = self::contentTypes['patchGroup'][0])
    {
