...
class HiddenApi
{
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getSyncExternalsystemsIdTestRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
    ...
    public function getSyncLogsRequest($page = 1, $limit = null, $es_ids = null, $job_ids = null, $start_date = null, $end_date = null, $types = null, $query = null, $levels = null, $is_dry_run = null, $body = null)
    {
        if ($limit !== null && strlen($limit) > 100) {
            throw new \InvalidArgumentException('invalid length for "$limit" when calling HiddenApi.getSyncLogs, must be smaller than or equal to 100.');
        }
        if ($limit !== null && strlen($limit) < 1) {
            throw new \InvalidArgumentException('invalid length for "$limit" when calling HiddenApi.getSyncLogs, must be bigger than or equal to 1.');
        }
